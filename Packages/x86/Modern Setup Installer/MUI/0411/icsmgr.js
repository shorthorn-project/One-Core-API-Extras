...
var L_ERR_HN_UNAVAILABLE_Text = "使用しているコンピュータはネットワーク経由でインターネットに接続していません。<br><br>接続を復元するには、ネットワーク ケーブルがネットワークとこのコンピュータに正しく接続されていることを確認してください。";


var L_ERRSTOPPED_Text = "インターネット接続の共有は、このネットワークでは現在利用できません。接続をやり直す場合は、<b>[再試行]</b> をクリックしてください。";
var L_ERR_PERM_DISCONNECTED_Text = "インターネット接続の共有が切断されました。インターネットを接続するために、高速アダプタ (広帯域など) を使用している場合は、ケーブルが正しく接続されていて、アダプタの構成が正しいことを確認してください。<br><br>接続をやり直す場合は、<b>[再試行]</b> をクリックしてください。";
var L_ERRTIMEOUT_Text = "インターネットの接続に問題があります。原因として、接続がタイムアウトしたか、共有インターネット接続が正しく構成されていない可能性があります。<br><br>接続をやり直す場合は、<b>[再試行]</b> をクリックしてください。";
var L_ERR_LAN_UNAVAILABLE1_Text = "ご使用のコンピュータはネットワーク経由でインターネットに接続していません。<br><br>ネットワークの設定を確認してインターネットに接続できることを確かめてから、やり直してください。";
var L_ERR_LAN_UNAVAILABLE2_Text = "ご使用のコンピュータはネットワーク経由でインターネットに接続していません。<br><br>次の方法の 1 つを選択してください:";
