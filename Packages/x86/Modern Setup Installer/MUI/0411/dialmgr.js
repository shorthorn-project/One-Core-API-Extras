...
var L_REGSRV_Text      = "ご使用のコンピュータはユーザー登録サーバーに接続しています。";
var L_ACTSRV_Text      = "ご使用のコンピュータはライセンス認証サーバーに接続しています。";
var L_ACT_REG_SRV_Text = "ご使用のコンピュータはライセンス認証サーバーとユーザー登録サーバーに接続しています。";

var L_REGCOM_Text      = "Windows をユーザー登録しています... ";
var L_REGCOM2_Text     = "コンピュータをユーザー登録しています... ";
var L_ACTCOM_Text      = "Windows のライセンス認証を行っています... ";
var L_ACTREGCOM_Text   = "Windows のライセンス認証とユーザー登録を行っています... ";
...
var L_PostToOEMandMS_Text = "フリーダイヤルを使って Microsoft と %1 にユーザー登録します。";
var L_PostToMS_Text       = "フリーダイヤルを使って Microsoft にユーザー登録します。";
var L_PostToOEM_Text      = "フリーダイヤルを使って %1 にユーザー登録します。";
var L_PrepToActRegOnline_Text  = "オンラインでライセンス認証の手続きとユーザー登録を行う準備をしています";


var L_PrepToActReg_Text   = "フリーダイヤルを使って Microsoft にライセンス認証の手続きとユーザー登録を行います。";
var L_PrepToActReg2_Text  = "フリーダイヤルを使って Microsoft に Windows のライセンス認証の手続きと %1 にユーザー登録を行います。";
var L_PrepToActReg3_Text  = "フリーダイヤルを使って Microsoft に Windows のライセンス認証の手続きとユーザー登録、%1 にユーザー登録を行います。";
var L_PrepToAct_Text      = "フリーダイヤルを使って Microsoft に Windows のライセンス認証の手続きを行います。";
...
var L_ConnectToOnlineAct_Text     = "オンライン ライセンス認証サーバーに接続しています";
var L_ConnectToOnlineActReg_Text = "オンライン ライセンス認証サーバーとユーザー登録サーバーに接続しています";
var L_ConnectToOnlineReg_Text     = "オンライン ユーザー登録サーバーに接続しています";
