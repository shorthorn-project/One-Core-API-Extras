...
var L_YourUserName_Text  = "ユーザー名(<U>U</U>):";
var L_YourPassword_Text  = "ユーザー パスワード(<u>W</u>):";
var L_YourPhone_Text     = "ISP の電話番号(<u>P</u>):";
var L_StaticIPAddrX_Text = "* 静的 IP (インターネット プロトコル) アドレス (<u>C</u>):";
var L_StaticIPAddr_Text  = "静的 IP (インターネット プロトコル) アドレス (<u>C</u>):";
var L_PreferredDNSX_Text = "* 優先 DNS (ドメイン ネーム システム)(<U>R</U>):";
var L_PreferredDNS_Text  = "優先 DNS (ドメイン ネーム システム)(<U>R</U>):";
var L_AlternateDNSX_Text = "* 代替 DNS (ドメイン ネーム システム(<U>A</U>):";
var L_AlternateDNS_Text  = "代替 DNS (ドメイン ネーム システム(<U>A</U>):";
var L_SampleIPRange_Text = "範囲: 1-223.0-255.0-255.0-255";
var L_OptionalField_Text = "(省略可能)";
