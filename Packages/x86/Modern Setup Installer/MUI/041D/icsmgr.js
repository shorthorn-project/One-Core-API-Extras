...
var L_ERR_HN_UNAVAILABLE_Text = "Datorn är inte längre ansluten till Internet via ditt nätverk. <br><br> Kontrollera att nätverkskabeln är korrekt ansluten till datorn och hemnätverket.";


var L_ERRSTOPPED_Text = "Internet-anslutningsdelning är inte tillgängligt i nätverket för närvarande. Klicka på <b>Försök igen</b> om du vill försöka ansluta igen.";
var L_ERR_PERM_DISCONNECTED_Text = "Internet-anslutningsdelning har kopplats från. Om du använder ett höghastighetskort för att ansluta till Internet (t ex bredband) bör du kontrollera att kortet har konfigurerats korrekt och att kablarna är ordentligt anslutna.<br><br>Klicka på <b>Försök igen</b> om du vill försöka ansluta igen.";
var L_ERRTIMEOUT_Text = "Det gick inte att ansluta till Internet. Antingen har anslutningen gjort time-out eller så är den här datorn inte korrekt konfigurerad för att använda den delade Internet-anslutningen. <br><br>Klicka på <b>Försök igen</b> om du vill försöka ansluta igen.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Din dator är inte ansluten till Internet via ditt nätverk. <br><br>Kontrollera dina nätverksinställningar så att du kan ansluta till Internet och försök sedan igen.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Din dator är inte ansluten till Internet via ditt nätverk. <br><br>Välj en av följande metoder:";
