...
var L_EnterValidPhoneNumber_Text = "Nie mo¿na usun¹æ ca³ego numeru telefonu.";
...
var L_altnumber_Text = "Wybierz ten numer <u>a</u>lternatywny:";
var L_altnumber01_Text = "* Wybierz ten numer <u>a</u>lternatywny:";
var L_outsideline_Text = "Do³¹cz ten <u>n</u>umer, aby uzyskaæ dostêp do linii zewnêtrznej:";
var L_outsideline01_Text = "* Do³¹cz ten <u>n</u>umer, aby uzyskaæ dostêp do linii zewnêtrznej:";
var L_callwaiting_Text = "Wy³¹cz powiadamianie <u>o</u> po³¹czeniu oczekuj¹cym:";
var L_callwaiting01_Text = "* Wy³¹cz powiadamianie <u>o</u> po³¹czeniu oczekuj¹cym:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Aby kontynuowaæ bez wykonywania tego zadania, kliknij przycisk <b>Przypomnij mi póŸniej</b>.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " Przypo<u>m</u>nij mi póŸniej ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "Instalator nie mo¿e po³¹czyæ siê z tym numerem, aby wykonaæ aktywacjê i rejestracjê tego komputera.";
    var L_tbstr2_Text = "Instalator nie mo¿e po³¹czyæ siê z tym numerem, aby wykonaæ aktywacjê tego komputera.";
    var L_tbstr3_Text = "Instalator nie mo¿e po³¹czyæ siê z tym numerem, aby zarejestrowaæ ten komputer.";

    var L_tbstr4_Text = "Aby kontynuowaæ bez wykonywania aktywacji i rejestrowania tego komputera, kliknij przycisk <b>Pomiñ</b>.";
    var L_tbstr5_Text = "Aby kontynuowaæ bez wykonywania aktywacji tego komputera, kliknij przycisk <b>Pomiñ</b>.";
    var L_tbstr6_Text = "Aby kontynuowaæ bez rejestrowania komputera, kliknij przycisk <b>Pomiñ</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Rejestracja i aktywacja w trybie online s¹ obecnie niedostêpne w Twoim kraju lub regionie. Aby zarejestrowaæ komputer nie u¿ywaj¹c po³¹czenia internetowego, skontaktuj siê z %1. Mo¿esz wykonaæ aktywacjê tej kopii systemu Windows przy u¿yciu po³¹czenia internetowego lub kontaktuj¹c siê telefonicznie z firm¹ Microsoft.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Rejestracja i aktywacja w trybie online s¹ obecnie niedostêpne w Twoim kraju lub regionie. Mo¿esz wykonaæ aktywacjê tej kopii systemu Windows przy u¿yciu po³¹czenia internetowego lub kontaktuj¹c siê telefonicznie z firm¹ Microsoft. Po³¹czenie internetowe jest wymagane, aby zarejestrowaæ tê kopiê systemu Windows w firmie Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Aktywacja w trybie online jest obecnie niedostêpna w Twoim kraju lub regionie. Mo¿esz wykonaæ aktywacjê tej kopii systemu Windows przy u¿yciu po³¹czenia internetowego lub kontaktuj¹c siê telefonicznie z firm¹ Microsoft. Aby zarejestrowaæ komputer nie u¿ywaj¹c po³¹czenia internetowego, skontaktuj siê z %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "Aktywacja w trybie online jest obecnie niedostêpna w Twoim kraju lub regionie. Mo¿esz wykonaæ aktywacjê tej kopii systemu Windows przy u¿yciu po³¹czenia internetowego lub kontaktuj¹c siê telefonicznie z firm¹ Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Rejestracja w trybie online jest obecnie niedostêpna w Twoim kraju lub regionie. Aby zarejestrowaæ komputer nie u¿ywaj¹c po³¹czenia internetowego, skontaktuj siê z %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
