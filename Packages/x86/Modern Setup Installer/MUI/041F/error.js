...
var L_callwaiting_Text = "Çaðrý bekletmeyi <u>d</u>evre dýþý býrak:";
var L_callwaiting01_Text = "* <u>A</u>rama bekletmeyi devre dýþý býrak:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Bu görevi gerçekleþtirmeden devam ermek için, <b>Sonra anýmsat</b>'ý týklatýn.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " So<u>n</u>ra Anýmsat ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "Kur, bilgisayarýnýzý etkinleþtirmek ve kaydettirmek üzere bu numaraya baðlanamýyor.";
    var L_tbstr2_Text = "Kur bilgisayarýnýzý etkinleþtirmek için bu numaraya baðlanamadý.";
    var L_tbstr3_Text = "Kur, bilgisayarýnýzý kaydettirmek üzere bu numaraya baðlanamýyor.";
    ...
    var L_tbstr6_Text = "Bilgisayarýnýzýn kaydýný yaptýrmadan devam etmek için, <b>Atla</b>'yý týklatýn.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Çevrimiçi kayýt ve etkinleþtirme þu anda ülkenizde ya da bölgenizde kullanýlmýyor. Bilgisayarýnýzý Internet baðlantýsý olmadan kaydettirmek için %1 ile temasa geçin. Internet baðlantýsý kullanarak ya da Microsoft'u telefonla arayarak Windows kopyanýzý etkinleþtirebilirsiniz.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Çevrimiçi kayýt ve etkinleþtirme þu anda ülkenizde ya da bölgenizde kullanýlmýyor. Windows'u Internet baðlantýnýzý kullanarak veya Microsoft'u telefonla arayarak etkinleþtirebilirsiniz. Windows'u Microsoft ile etkinleþtirmek için bir Internet baðlantýsý gerekiyor.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Çevrimiçi etkinleþtirme þu anda ülkenizde ya da bölgenizde kullanýlmýyor. Windows'u Internet baðlantýnýzý kullanarak veya Microsoft'u telefonla arayarak etkinleþtirebilirsiniz. Windows'u Internet baðlantýsý olmadan etkinletirmek için %1 ile baðlantýya geçiniz.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "Çevrimiçi etkinleþtirme þu anda ülkenizde ya da bölgenizde kullanýlmýyor. Windows kopyanýzý Internet baðlantýsý kullanarak ya da Microsoft'a telefon ederek etkinleþtirebilirsiniz.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Çevrimiçi kayýt ve etkinleþtirme þu anda ülkenizde ya da bölgenizde kullanýlmýyor. Bilgisayarýnýzý Internet baðlantýsý olmadan kaydettirmek için %1 ile temasa geçin.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
