...
var L_RewardStr1_Text="Aferin!";
var L_RewardStr2_Text="Ýþte bu kadar!";
var L_RewardStr3_Text="Baþardýnýz!";
var L_RewardStr4_Text="Mükemmel!";
var L_RewardStr5_Text="Ýþte bu kadar kolay!";
var L_RewardStr6_Text="Olaðanüstü!";
var L_RewardStr7_Text="Bravo!";
var L_RewardStr8_Text="Etkileyici!";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "Takýmýnýz, rakibiyle oynadýðý maçý kazandý.";
