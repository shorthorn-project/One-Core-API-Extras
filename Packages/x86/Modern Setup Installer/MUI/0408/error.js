...
var L_EnterValidPhoneNumber_Text = "Δεν είναι δυνατή ή διαγραφή ολόκληρου του αριθμού τηλεφώνου.";
...
var L_altnumber_Text = "<u>Κ</u>λήση αυτού του εναλλακτικού αριθμού:";
var L_altnumber01_Text = "* <u>Κ</u>λήση αυτού του εναλλακτικού αριθμού:";
var L_outsideline_Text = "Συμπερίληψη αυτού του αριθμού για λήψη ε<u>ξ</u>ωτερικής γραμμής:";
var L_outsideline01_Text = "* Συμπερίληψη αυτού του αριθμού για λήψη ε<u>ξ</u>ωτερικής γραμμής:";
var L_callwaiting_Text = "Απενεργοποίηση <u>α</u>ναμονής κλήσης:";
var L_callwaiting01_Text = "* Απενεργοποίηση <u>α</u>ναμονής κλήσης:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Για να συνεχίσετε χωρίς να εκτελέσετε αυτήν την εργασία, κάντε κλικ στο κουμπί <b>Υπενθύμιση αργότερα</b>.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " <u>Υ</u>πενθύμιση αργότερα ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "Το πρόγραμμα Εγκατάστασης δεν είναι δυνατό να συνδεθεί σε αυτόν τον αριθμό για να ενεργοποιήσει και να δηλώσει τον υπολογιστή σας.";
    var L_tbstr2_Text = "Το πρόγραμμα εγκατάστασης δεν μπορεί να συνδεθεί με αυτόν τον αριθμό για να ενεργοποιήσει τον υπολογιστή σας.";
    var L_tbstr3_Text = "Το πρόγραμμα εγκατάστασης δεν μπορεί να συνδεθεί με αυτόν τον αριθμό για να δηλώσει τον υπολογιστή σας.";

    var L_tbstr4_Text = "Για να συνεχίσετε χωρίς να ενεργοποιήσετε και να δηλώσετε τον υπολογιστή σας, κάντε κλικ στο κουμπί <b>Παράλειψη</b>.";
    var L_tbstr5_Text = "Για να συνεχίσετε χωρίς να ενεργοποιήσετε τον υπολογιστή σας, κάντε κλικ στο κουμπί <b>Παράλειψη</b>.";
    var L_tbstr6_Text = "Για να συνεχίσετε, χωρίς να δηλώσετε τον υπολογιστή σας, κάντε κλικ στο κουμπί <b>Παράλειψη</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Η ηλεκτρονική δήλωση και η ενεργοποίηση δεν είναι διαθέσιμες αυτήν τη στιγμή στη χώρα ή στην περιοχή σας. Για να δηλώσετε τον υπολογιστή σας, χωρίς σύνδεση με Internet, επικοινωνήστε στο %1. Μπορείτε να ενεργοποιήσετε το αντίγραφο των Windows χρησιμοποιώντας μια σύνδεση με το Internet ή επικοινωνώντας με τη Microsoft μέσω τηλεφώνου.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Η ηλεκτρονική δήλωση και η ενεργοποίηση δεν είναι διαθέσιμες αυτήν τη στιγμή στη χώρα ή στην περιοχή σας. Μπορείτε να ενεργοποιήσετε το αντίγραφο των Windows χρησιμοποιώντας μια σύνδεση με το Internet ή επικοινωνώντας με τη Microsoft μέσω τηλεφώνου. Χρειάζεστε μια σύνδεση με το Internet, για να δηλώσετε το αντίγραφο των Windows στη Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Η ηλεκτρονική δήλωση και η ενεργοποίηση δεν είναι διαθέσιμες αυτήν τη στιγμή στη χώρα ή στην περιοχή σας. Μπορείτε να ενεργοποιήσετε το αντίγραφο των Windows χρησιμοποιώντας μια σύνδεση με το Internet ή επικοινωνώντας με τη Microsoft μέσω τηλεφώνου. Για να δηλώσετε τον υπολογιστή σας χωρίς σύνδεση με το Internet, επικοινωνήστε στο %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "Προς το παρόν, η ηλεκτρονική ενεργοποίηση δεν είναι διαθέσιμη στη χώρα σας ή στην περιοχή σας. Μπορείτε να ενεργοποιήσετε το αντίγραφο των Windows χρησιμοποιώντας μια σύνδεση με το Internet ή επικοινωνώντας τηλεφωνικά με τη Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Προς το παρόν, η ηλεκτρονική δήλωση δεν είναι διαθέσιμη στη χώρα σας ή στην περιοχή σας. Για να δηλώσετε τον υπολογιστή σας χωρίς σύνδεση στο Internet, επικοινωνήστε με το %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
