...
var L_ERR_HN_UNAVAILABLE_Text = "Ο υπολογιστής σας δεν είναι πλέον συνδεδεμένος στο Internet μέσω του δικτύου σας. <br><br>Για να αποκαταστήσετε τη σύνδεση, βεβαιωθείτε ότι το καλώδιο δικτύου είναι καλά τοποθετημένο στον υπολογιστή σας καθώς και στο δίκτυο.";


var L_ERRSTOPPED_Text = "Η Κοινόχρηστη σύνδεση στο Internet δεν είναι αυτήν τη στιγμή διαθέσιμη στο δίκτυό σας. Κάντε κλικ στο κουμπί <b>Επανάληψη</b> για να προσπαθήσετε να συνδεθείτε ξανά.";
var L_ERR_PERM_DISCONNECTED_Text = "Η Κοινόχρηστη σύνδεση στο Internet έχει αποσυνδεθεί. Εάν χρησιμοποιείτε έναν προσαρμογέα υψηλής ταχύτητας για να συνδεθείτε στο Internet (π.χ. Broadband), βεβαιωθείτε ότι ο προσαρμογέας έχει ρυθμιστεί σωστά, καθώς και ότι τα καλώδια είναι συνδεδεμένα με ασφάλεια.<br><br>Κάντε κλικ στο κουμπί <b>Επανάληψη</b> για να προσπαθήσετε να συνδεθείτε ξανά.";
var L_ERRTIMEOUT_Text = "Υπάρχει πρόβλημα με τη σύνδεση στο Internet. Είτε έχει λήξει η σύνδεσή σας είτε αυτός ο υπολογιστής δεν έχει τις σωστές παραμέτρους για να χρησιμοποιεί την Κοινόχρηστη σύνδεση στο Internet. <br><br>Κάντε κλικ στο κουμπί <b>Επανάληψη</b> για να προσπαθήσετε να συνδεθείτε ξανά.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Ο υπολογιστής σας δεν είναι συνδεδεμένος στο Internet μέσω του δικτύου σας. <br><br>Ελέγξτε τις ρυθμίσεις δικτύου σας και βεβαιωθείτε ότι μπορείτε να συνδεθείτε στο Internet και προσπαθήστε πάλι.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Ο υπολογιστής σας δεν είναι συνδεδεμένος στο Internet μέσω του δικτύου σας. <br><br>Επιλέξτε μία από τις παρακάτω μεθόδους:";
