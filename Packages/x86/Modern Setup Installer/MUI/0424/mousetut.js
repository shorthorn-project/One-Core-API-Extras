...
var L_RewardStr1_Text="Odlièno!";
var L_RewardStr2_Text="Zelo dobro!";
var L_RewardStr3_Text="Tako je prav!";
var L_RewardStr4_Text="Izvrstno!";
var L_RewardStr5_Text="Tako preprosto je to!";
var L_RewardStr6_Text="Izjemno!";
var L_RewardStr7_Text="Bravo!";
var L_RewardStr8_Text="Èudovito!";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "Kranjski Kragulji so premagali novomeške Lisjake.";
