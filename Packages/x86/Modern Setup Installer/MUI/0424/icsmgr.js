...
var L_ERR_HN_UNAVAILABLE_Text = "Raèunalnik ni veè povezan z internetom prek omrežja. <br><br>Èe želite povezavo ponovno vzpostaviti, poskrbite, da bo omrežni kabel ustrezno prikljuèen na raèunalnik in v domaèe omrežje.";


var L_ERRSTOPPED_Text = "Skupna raba internetne povezave trenutno v vašem omrežju trenutno ni na voljo. Èe želite poskusiti ponovno vzpostaviti povezavo, kliknite <b>Poskusi znova</b>.";
var L_ERR_PERM_DISCONNECTED_Text = "Skupna raba internetne povezave je bila prekinjena. Èe za povezovanje z internetom uporabljate hitro (npr. širokopasovno) kartico, poskrbite, da bo pravilno konfigurirana in da bodo kabli dobro pritrjeni.<br><br>Èe želite poskusiti ponovno vzpostaviti povezavo, kliknite <b>Poskusi znova</b>.";
var L_ERRTIMEOUT_Text = "Težava pri vzpostavljanju povezave z internetom. Èasovna omejitev je potekla ali pa raèunalnik ni konfiguriran tako, da bi lahko uporabljal skupno rabo internetne povezave. <br><br>Èe želite poskusiti ponovno vzpostaviti povezavo, kliknite <b>Poskusi znova</b>.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Raèunalnik nima vzpostavljene povezave z internetom prek omrežja. <br><br>Preverite omrežne namestitve in poskrbite, da lahko vzpostavite povezavo z internetom, nato pa poskusite znova.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Raèunalnik nima vzpostavljene povezave z internetom prek omrežja. <br><br>Izberite eno od teh metod:";
