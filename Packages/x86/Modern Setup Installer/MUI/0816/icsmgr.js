...
var L_ERR_HN_UNAVAILABLE_Text = "O computador já não está ligado à Internet através da rede.<br><br> Para restaurar a ligação certifique-se que o cabo de rede está bém ligado no computador e na rede.";


var L_ERRSTOPPED_Text = "A 'Partilha de ligação à Internet' não está actualmente disponível na rede. Clique em <b>Repetir</b> para tentar ligar novamente.";
var L_ERR_PERM_DISCONNECTED_Text = "A partilha de ligação à Internet foi desligada. Se estiver a utilizar uma placa de alta velocidade para ligar à Internet (por exemplo, banda larga), certifique-se de que a placa foi correctamente configurada e de que os cabos estão firmemente ligados.<br><br>Clique em <b>Repetir</b> para tentar ligar novamente.";
var L_ERRTIMEOUT_Text = "Existe um problema ao ligar à Internet. O tempo de espera da ligação foi excedido ou este computador não está correctamente configurado para utilizar a ligação partilhada à Internet. <br><br>Clique em <b>Repetir</b> para tentar ligar novamente.";
var L_ERR_LAN_UNAVAILABLE1_Text = "O computador não está ligado à Internet através da rede. <br><br>Verifique as definições de rede, confirme que pode ligar-se à Internet e, em seguida, tente de novo.";
var L_ERR_LAN_UNAVAILABLE2_Text = "O computador não está ligado à Internet através da rede. <br><br>Seleccione um dos seguintes métodos:";
