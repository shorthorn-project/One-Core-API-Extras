...
var L_REF_STATUS_DIALING_Text           = "正在撥號...";
var L_REF_STATUS_LOCATING_Text          = "尋找服務";
var L_REF_STATUS_CONNECTING_Text        = "正在連線到服務";
var L_REF_STATUS_CONNECTED_Text         = "已經連線";

var L_REF_STATUS_DOWNLOAD_Text          = "正在下載網際網路服務提供者的資訊...";
var L_REFDIALTITLE_TEXT                 = "尋找您所在區域的網際網路服務提供者";
var L_REFDIALINTRO_TEXT                 = "Microsoft 正在抓取您所在區域的網際網路服務提供者 (ISP) 清單，讓您選擇一個連線提供者。";
...
var L_drdyref_2_ICS_Text = "Windows 現在會使用共用的網際網路連線來遷移現有的網際網路帳戶設定，這樣才能用於新的電腦。";

var L_drdyref_4_ICS_Text = "如果要繼續，請提供資訊，然後按 <b>[下一步]</b>。如果要繼續但不想重新建立現有的網際網路帳戶，請按 <b>[跳過]</b>。";

var L_drdymig_2_ICS_Text = "Windows 會使用共用的網際網路連線來重新建立現有的網際網路帳戶。請按 <b>[下一步]</b> 繼續。";

var L_drdymig_4_ICS_Text = "如果要繼續，請提供資訊，然後按 <b>[下一步]</b>。如果要繼續但不想重新建立現有的網際網路帳戶，請按 <b>[跳過]</b>。";
