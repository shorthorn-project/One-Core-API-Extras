...
var L_altnumber_Text = "<u>R</u>ing op til dette alternative nummer:";
var L_altnumber01_Text = "* <u>R</u>ing op til dette alternative nummer:";
var L_outsideline_Text = "Medtag dette nummer for at få en <u>u</u>dgående linje:";
var L_outsideline01_Text = "* Medtag dette nummer for at få en <u>u</u>gående linje:";
var L_callwaiting_Text = "Deaktiver <u>b</u>anke-på-funktion:";
var L_callwaiting01_Text = "* Deaktiver <u>b</u>anke-på-funktion:";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "Installationsprogrammet kan ikke oprette forbindelse til dette nummer for at aktivere og registrere din computer.";
    var L_tbstr2_Text = "Installationsprogrammet kan ikke oprette forbindelse til dette nummer for at aktivere din computer.";
    var L_tbstr3_Text = "Installationsprogrammet kan ikke oprette forbindelse til dette nummer for at registrere din computer.";

    var L_tbstr4_Text = "Hvis du vil fortsætte uden at aktivere og registrere din computer, skal du klikke på <b>Spring over</b>.";
    var L_tbstr5_Text = "Klik på <b>Spring over</b> for at fortsætte uden at aktivere din computer.";
    var L_tbstr6_Text = "Klik på <b>Spring over</b>, hvis du vil fortsætte uden at registrere computeren.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Onlineregistrering og -aktivering er ikke tilgængelig i øjeblikket i dit land eller område. Hvis du vil registrere din computer uden en Internetforbindelse, skal du kontakte %1. Du kan aktivere din kopi af Windows ved hjælp af en Internetforbindelse eller ved at ringe til Microsoft.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Onlineregistrering og -aktivering er ikke tilgængelig i øjeblikket i dit land eller område. Du kan aktivere din kopi af Windows senere ved hjælp af en Internetforbindelse eller ved at ringe til Microsoft. Det er nødvendigt at have en Internetforbindelse for at kunne registrere din kopi af Windows hos Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Onlineaktivering er ikke tilgængelig i øjeblikket i dit land eller område. Du kan aktivere din kopi af Windows ved hjælp af en Internetforbindelse eller ved at ringe til Microsoft. Hvis du vil registrere din computer uden en Internetforbindelse, skal du kontakte %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "Onlineaktivering er ikke tilgængelig i øjeblikket i dit land eller område. Du kan aktivere din kopi af Windows ved hjælp af en Internetforbindelse eller ved at ringe til Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Onlineregistrering er ikke tilgængelig i øjeblikket i dit land eller område. Hvis du vil registrere din computer uden en Internetforbindelse, skal du kontakte %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
