...
var L_EnterValidPhoneNumber_Text = "Nemoûno odstr·niù celÈ telefÛnne ËÌslo.";
...
var L_altnumber_Text = "VytoËiù <u>n</u>·hradnÈ ËÌslo:";
var L_altnumber01_Text = "* VytoËiù <u>n</u>·hradnÈ ËÌslo:";
var L_outsideline_Text = "VytoËiù ËÌslo pre prÌstup na <u>v</u>onkajöiu linku:";
var L_outsideline01_Text = "* VytoËiù ËÌslo pre prÌstup na <u>v</u>onkajöiu linku:";
var L_callwaiting_Text = "Vypn˙ù Ëa<u>k</u>anie na hovor:";
var L_callwaiting01_Text = "* Vypn˙ù Ëa<u>k</u>anie na hovor:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Ak chcete pokraËovaù bez registr·cie poËÌtaËa, kliknite na tlaËidlo <b>Upozorniù neskÙr</b>.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " <u>U</u>pozorniù neskÙr ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "Inötal·tor sa nemÙûe pripojiù k zadanÈmu ËÌslu a aktivovaù a registrovaù poËÌtaË.";
    var L_tbstr2_Text = "Inötal·tor sa nemÙûe pripojiù k zadanÈmu ËÌslu a aktivovaù poËÌtaË.";
    var L_tbstr3_Text = "Inötal·tor sa nemÙûe pripojiù k zadanÈmu ËÌslu a registrovaù poËÌtaË.";

    var L_tbstr4_Text = "Ak chcete pokraËovaù bez aktiv·cie a registr·cie poËÌtaËa, kliknite na tlaËidlo <b>PreskoËiù</b>.";
    var L_tbstr5_Text = "Ak chcete pokraËovaù bez aktiv·cie poËÌtaËa, kliknite na tlaËidlo <b>PreskoËiù</b>.";
    var L_tbstr6_Text = "Ak chcete pokraËovaù bez registr·cie poËÌtaËa, kliknite na tlaËidlo <b>PreskoËiù</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Registr·cia a aktiv·cia online nie je vo vaöej krajine alebo na vaöom ˙zemÌ k dispozÌcii. Ak chcete zaregistrovaù poËÌtaË bez internetovÈho pripojenia, obr·ùte sa na %1. KÛpiu systÈmu Windows mÙûete aktivovaù pomocou internetovÈho pripojenia alebo telefonicky v spoloËnosti Microsoft.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Registr·cia a aktiv·cia online nie je vo vaöej krajine alebo na vaöom ˙zemÌ k dispozÌcii. KÛpiu systÈmu Windows mÙûete aktivovaù pomocou internetovÈho pripojenia alebo telefonicky v spoloËnosti Microsoft. Na registr·ciu kÛpie systÈmu Windows v spoloËnosti Microsoft je potrebnÈ internetovÈ pripojenie.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Registr·cia online nie je vo vaöej krajine alebo na vaöom ˙zemÌ k dispozÌcii. KÛpiu systÈmu Windows mÙûete aktivovaù pomocou internetovÈho pripojenia alebo telefonicky v spoloËnosti Microsoft. Ak chcete zaregistrovaù poËÌtaË bez internetovÈho pripojenia, obr·ùte sa na %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "Registr·cia online nie je vo vaöej krajine alebo na vaöom ˙zemÌ k dispozÌcii. KÛpiu systÈmu Windows mÙûete aktivovaù pomocou internetovÈho pripojenia alebo telefonicky v spoloËnosti Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Registr·cia online nie je vo vaöej krajine alebo na vaöom ˙zemÌ k dispozÌcii. Ak chcete zaregistrovaù poËÌtaË bez internetovÈho pripojenia, obr·ùte sa na %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
