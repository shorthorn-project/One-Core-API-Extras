...
var L_ERR_HN_UNAVAILABLE_Text = "Pripojenie tohto poËÌtaËa na Internet prostrednÌctvom siete bolo preruöenÈ. <br><br>Ak chcete obnoviù pripojenie, skontrolujte, Ëi je sieùov˝ k·bel bezpeËne pripojen˝ k poËÌtaËu a k poËÌtaËovej sieti.";


var L_ERRSTOPPED_Text = "Zdieæanie internetovÈho pripojenia moment·lne nie je vo vaöej sieti k dispozÌcii. Ak sa chcete znovu pok˙siù o pripojenie, kliknite na tlaËidlo <b>Znova</b>.";
var L_ERR_PERM_DISCONNECTED_Text = "Zdieæanie internetovÈho pripojenia bolo odpojenÈ. Ak pouûÌvate adaptÈr pre vysokor˝chlostnÈ pripojenie na Internet (napr. Broadband), uistite sa, ûe adaptÈr je spr·vne nakonfigurovan˝ a k·ble s˙ bezpeËne pripojenÈ.<br><br>Ak sa chcete znovu pok˙siù o pripojenie, kliknite na tlaËidlo <b>Znova</b>.";
var L_ERRTIMEOUT_Text = "Vyskytol sa problÈm s internetov˝m pripojenÌm, alebo uplynul Ëasov˝ limit pripojenia, prÌpadne tento poËÌtaË nie je spr·vne nakonfigurovan˝ na pouûitie zdieæanÈho internetovÈho pripojenia. <br><br>Ak sa chcete znovu pok˙siù o pripojenie, kliknite na tlaËidlo <b>Znova</b>.";
var L_ERR_LAN_UNAVAILABLE1_Text = "PoËÌtaË nie je pripojen˝ na Internet prostrednÌctvom siete. <br><br>Skontrolujte nastavenie siete a uistite sa, ûe sa mÙûete pripojiù na Internet. Potom to sk˙ste znova.";
var L_ERR_LAN_UNAVAILABLE2_Text = "PoËÌtaË nie je pripojen˝ na Internet prostrednÌctvom siete. <br><br>Vyberte jednu z nasleduj˙cich metÛd:";
