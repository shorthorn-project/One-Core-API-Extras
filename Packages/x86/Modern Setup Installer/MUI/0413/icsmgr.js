...
var L_ERR_HN_UNAVAILABLE_Text = "De computer is niet langer via het netwerk met het Internet verbonden. <br><br>Controleer of de netwerkkabel correct op de computer en het netwerk is aangesloten.";


var L_ERRSTOPPED_Text = "Internet-verbinding delen is op dit moment niet in het netwerk beschikbaar. Klik op <b>Opnieuw</b> om opnieuw verbinding te maken.";
var L_ERR_PERM_DISCONNECTED_Text = "De verbinding met Internet-verbinding delen is verbroken. Als u voor de verbinding met het Internet een hogesnelheidsadapter gebruikt (bijvoorbeeld breedband), dient u te controleren u of de adapter juist is geconfigureerd en of de kabels correct zijn aangesloten.<br><br>Klik op <b>Opnieuw</b> om opnieuw verbinding te maken.";
var L_ERRTIMEOUT_Text = "Er is een probleem opgetreden bij het maken van een verbinding met het Internet. Er is mogelijk een time-out opgetreden voor de verbinding of deze computer is onjuist geconfigureerd voor Internet-verbinding delen. <br><br>Klik op <b>Opnieuw</b> om opnieuw verbinding te maken.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Uw computer heeft geen verbinding met het Internet via het netwerk.<br><br>Controleer de netwerkinstellingen en controleer of u verbinding met het Internet kunt maken en probeer het vervolgens opnieuw.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Uw computer heeft geen verbinding met het Internet via het netwerk. <br><br>Selecteer een van de volgende methoden:";
