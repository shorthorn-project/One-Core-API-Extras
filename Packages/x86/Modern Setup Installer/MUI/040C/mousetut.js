...
var L_RewardStr1_Text="Bien joué !";
var L_RewardStr2_Text="C'est ça !";
var L_RewardStr3_Text="Vous avez compris !";
var L_RewardStr4_Text="Excellent !";
var L_RewardStr5_Text="Quelle aisance !";
var L_RewardStr6_Text="Remarquable !";
var L_RewardStr7_Text="Bravo !";
var L_RewardStr8_Text="Incroyable !";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "La Coupe du monde s'annonce bien pour l'équipe de France.";
