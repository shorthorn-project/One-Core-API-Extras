...
var L_EnterValidPhoneNumber_Text = "Impossible de supprimer la totalité du numéro de téléphone.";
...
var L_altnumber_Text = "<u>C</u>omposer cet autre numéro :";
var L_altnumber01_Text = "* <u>C</u>omposer cet autre numéro :";
var L_outsideline_Text = "Inclure ce numéro pour obtenir une ligne e<u>x</u>térieure :";
var L_outsideline01_Text = "* Inclure ce numéro pour obtenir une ligne e<u>x</u>térieure :";
var L_callwaiting_Text = "Désactiver l'attente d'<u>a</u>ppel :";
var L_callwaiting01_Text = "* Désactiver l'attente d'<u>a</u>ppel :";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Pour passer à l'étape suivante sans effectuer cette tâche, cliquez sur <b>Plus tard</b>.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " P<u>l</u>us tard ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "Le programme d'installation ne peut pas se connecter à ce numéro pour activer et enregistrer votre ordinateur.";
    var L_tbstr2_Text = "Le programme d'installation ne peut pas se connecter à ce numéro pour activer votre ordinateur.";
    var L_tbstr3_Text = "Le programme d'installation ne peut pas se connecter à ce numéro pour enregistrer votre ordinateur.";

    var L_tbstr4_Text = "Pour passer à l'étape suivante sans activer ni enregistrer votre ordinateur, cliquez sur <b>Ignorer</b>.";
    var L_tbstr5_Text = "Pour passer à l'étape suivante sans activer votre ordinateur, cliquez sur <b>Ignorer</b>.";
    var L_tbstr6_Text = "Pour passer à l'étape suivante sans enregistrer votre ordinateur, cliquez sur <b>Ignorer</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "L'enregistrement et l'activation en ligne ne sont actuellement pas disponibles dans votre pays ou votre région. Pour enregistrer votre ordinateur sans connexion Internet, contactez %1. Vous pouvez activer Windows en utilisant une connexion Internet ou en contactant Microsoft par téléphone.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "L'enregistrement et l'activation en ligne ne sont actuellement pas disponibles dans votre pays ou votre région. Vous pouvez activer votre copie de Windows ultérieurement en utilisant une connexion Internet ou en contactant Microsoft par téléphone. Une connexion Internet est nécessaire pour enregistrer Windows auprès de Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "L'activation en ligne est actuellement indisponible dans votre pays ou votre région. Vous pouvez activer votre copie de Windows ultérieurement en utilisant une connexion Internet ou en contactant Microsoft par téléphone. Pour enregistrer votre ordinateur ultérieurement avec une connexion Internet, contactez %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "L'activation en ligne est actuellement indisponible dans votre pays ou votre région. Vous pouvez activer votre copie de Windows ultérieurement en utilisant une connexion Internet ou en contactant Microsoft par téléphone.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "L'enregistrement en ligne n'est actuellement pas disponible dans votre pays ou votre région. Pour enregistrer votre ordinateur sans connexion Internet, contactez %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
