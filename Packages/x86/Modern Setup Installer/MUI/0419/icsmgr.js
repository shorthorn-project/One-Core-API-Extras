...
var L_ERR_HN_UNAVAILABLE_Text = "Подключение к Интернету по локальной сети более недоступно.<br><br>Для восстановления подключения убедитесь, что сетевой кабель подключен к компьютеру.";


var L_ERRSTOPPED_Text = "Общее подключение к Интернету в данное время недоступно в сети. Чтобы повторить попытку подключения, нажмите кнопку <b>Повторить</b>.";
var L_ERR_PERM_DISCONNECTED_Text = "Общее подключение к Интернету было отключено. Если для подключения используется высокоскоростной (широкополосный) адаптер, убедитесь, что он правильно настроен, и кабели надежно соединены.<br><br>Чтобы повторить попытку подключения, нажмите кнопку <b>Повторить</b>.";
var L_ERRTIMEOUT_Text = "Неполадка подключения к Интернету. Истекло время ожидания подключения, или компьютер не был правильно настроен для использования общего подключения к Интернету. <br><br>Чтобы повторить попытку подключения, нажмите кнопку <b>Повторить</b>.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Компьютер не подключен к Интернету по локальной сети. <br><br>Проверьте настройки локальной сети и убедитесь, что вы можете подключиться к Интернету, затем повторите попытку подключения.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Компьютер не подключен к Интернету по локальной сети. <br><br>Выберите одну из следующих возможностей:";
