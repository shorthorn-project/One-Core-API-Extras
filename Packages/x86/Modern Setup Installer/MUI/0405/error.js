...
var L_EnterValidPhoneNumber_Text = "Nelze odstranit celÈ telefonnÌ ËÌslo.";
...
var L_altnumber_Text = "<u>V</u>ytoËit n·hradnÌ ËÌslo:";
var L_altnumber01_Text = "* <u>V</u>ytoËit n·hradnÌ ËÌslo:";
var L_outsideline_Text = "VytoËit toto ËÌslo pro p¯Ìstup k <u>v</u>nÏjöÌ lince:";
var L_outsideline01_Text = "* VytoËit toto ËÌslo pro p¯Ìstup k <u>v</u>nÏjöÌ lince:";
var L_callwaiting_Text = "Zak·zat Ëe<u>k</u>·nÌ hovor˘:";
var L_callwaiting01_Text = "* Zak·zat Ëe<u>k</u>·nÌ hovor˘";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Chcete-li pokraËovat bez provedenÌ tohoto ˙kolu, klepnÏte na tlaËÌtko <b>P¯ipomenout pozdÏji</b>.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " P¯ipo<u>m</u>enout pozdÏji ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "InstalaËnÌ program se nem˘ûe p¯ipojit k zadanÈmu ËÌslu. Aktivaci a registraci poËÌtaËe nelze provÈst.";
    var L_tbstr2_Text = "InstalaËnÌ program se nem˘ûe p¯ipojit k zadanÈmu ËÌslu. Aktivaci poËÌtaËe nelze provÈst.";
    var L_tbstr3_Text = "InstalaËnÌ program se nem˘ûe p¯ipojit vytoËenÌm zadanÈho ËÌsla. Registraci poËÌtaËe nelze provÈst.";

    var L_tbstr4_Text = "Chcete-li pokraËovat bez aktivace a registrace poËÌtaËe, klepnÏte na tlaËÌtko <b>P¯eskoËit</b>.";
    var L_tbstr5_Text = "Chcete-li pokraËovat bez aktivace poËÌtaËe, klepnÏte na tlaËÌtko <b>P¯eskoËit</b>.";
    var L_tbstr6_Text = "Chcete-li pokraËovat bez registrace poËÌtaËe,, klepnÏte na tlaËÌtko <b>P¯eskoËit</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Registrace a aktivace online nejsou v souËasnÈ dobÏ ve vaöÌ oblasti k dispozici. Chcete-li poËÌtaË zaregistrovat bez p¯ipojenÌ k Internetu, obraùte se na %1. Svou kopii systÈmu Windows m˘ûete aktivovat pomocÌ p¯ipojenÌ k Internetu nebo telefonicky se z·stupcem spoleËnosti Microsoft.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Registrace a aktivace online nejsou v souËasnÈ dobÏ ve vaöÌ oblasti k dispozici. Svou kopii systÈmu Windows m˘ûete aktivovat pomocÌ p¯ipojenÌ k Internetu nebo telefonicky se z·stupcem spoleËnosti Microsoft. K registraci systÈmu Windows u spoleËnosti Microsoft je vyûadov·no p¯ipojenÌ k Internetu.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Aktivace online nenÌ v souËasnÈ dobÏ ve vaöÌ oblasti k dispozici. Svou kopii systÈmu Windows m˘ûete aktivovat pomocÌ p¯ipojenÌ k Internetu nebo telefonicky se z·stupcem spoleËnosti Microsoft. Chcete-li poËÌtaË zaregistrovat bez p¯ipojenÌ k Internetu, obraùte se na %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "Aktivace online nenÌ v souËasnÈ dobÏ ve vaöÌ oblasti k dispozici. Svou kopii systÈmu Windows m˘ûete aktivovat pomocÌ p¯ipojenÌ k Internetu nebo telefonicky se z·stupcem spoleËnosti Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Registrace online nenÌ v souËasnÈ dobÏ ve vaöÌ oblasti k dispozici. Chcete-li poËÌtaË zaregistrovat bez p¯ipojenÌ k Internetu, obraùte se na %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
