...
var L_RewardStr1_Text="Dobr· pr·ce!";
var L_RewardStr2_Text="To je ono!";
var L_RewardStr3_Text="Jde v·m to!";
var L_RewardStr4_Text="VynikajÌcÌ!";
var L_RewardStr5_Text="Vûdyù je to snadnÈ!";
var L_RewardStr6_Text="SkvÏle!";
var L_RewardStr7_Text="Bravo!";
var L_RewardStr8_Text="V˝bornÏ!";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "Sl·vie porazila Spartu.";
