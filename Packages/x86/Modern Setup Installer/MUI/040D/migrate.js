...
var L_REF_STATUS_DIALING_Text           = "מחייג...";
var L_REF_STATUS_LOCATING_Text          = "מאתר שירות";
var L_REF_STATUS_CONNECTING_Text        = "מתחבר לשירות";
var L_REF_STATUS_CONNECTED_Text         = "מחובר";

var L_REF_STATUS_DOWNLOAD_Text          = "מוריד מידע אודות ספקי שירותי אינטרנט...";
var L_REFDIALTITLE_TEXT                 = "מחפש ספקי שירותי אינטרנט באזור מגוריך";
var L_REFDIALINTRO_TEXT                 = "Microsoft מאחזרת רשימה של ספקי שירותי אינטרנט (ISP) באזור מגוריך כדי שתוכל לבחור את הספק הרצוי.";
...
var L_drdyref_2_ICS_Text = "Windows ישתמש כעת בהתקשרות המשותפת לאינטרנט לשם העברת הגדרת חשבון האינטרנט הקיים כדי שתוכל להשתמש בו במחשב החדש";

var L_drdyref_4_ICS_Text = "כדי להמשיך, ספק את המידע להלן ולחץ על <b>הבא</b>. כדי להמשיך מבלי להעביר חשבון קיים, לחץ על <b>דלג</b>.";

var L_drdymig_2_ICS_Text = "Windows ישתמש כעת בהתקשרות המשותפת לאינטרנט כדי להתחיל ביצירה מחדש של חשבון האינטרנט הקיים שלך.&nbsp; לחץ על <b>הבא</b> כדי להתחיל בהתקשרות.";

var L_drdymig_4_ICS_Text = "כדי להמשיך, ספק את המידע להלן ולחץ על <b>הבא</b>. כדי להמשיך מבלי ליצור מחדש חשבון אינטרנט קיים, לחץ על <b>דלג</b>.";
