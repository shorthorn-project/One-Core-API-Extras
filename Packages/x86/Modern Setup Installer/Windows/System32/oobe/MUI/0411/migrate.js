...
var L_REF_STATUS_DIALING_Text           = "ダイヤルしています...";
var L_REF_STATUS_LOCATING_Text          = "サービスを探しています";
var L_REF_STATUS_CONNECTING_Text        = "サービスへ接続しています";
var L_REF_STATUS_CONNECTED_Text         = "接続しました";

var L_REF_STATUS_DOWNLOAD_Text          = "ISP についての情報をダウンロードしています...";
var L_REFDIALTITLE_TEXT                 = "お住まいの地域のインターネット サービス プロバイダを検索しています";
var L_REFDIALINTRO_TEXT                 = "お住まいの地域にあるインターネット サービス プロバイダ (ISP) の一覧を取得しています。その一覧から使用する ISP を選択します。";
...
var L_drdyref_2_ICS_Text = "新しいコンピュータでも既存のインターネット アカウントが使えるように、共有インターネット接続を使用して設定を移行します。";

var L_drdyref_4_ICS_Text = "続けるには、以下の情報を入力して <b>[次へ]</b> をクリックしてください。既存のアカウントを移行しないで先に進むには、<b>[省略]</b>をクリックしてください。";

var L_drdymig_2_ICS_Text = "共有インターネット接続を使って、既存のインターネット アカウントの再確立を行います。&nbsp; 接続を開始するには、<b>[次へ]</b> をクリックしてください。";

var L_drdymig_4_ICS_Text = "続けるには、以下の情報を入力して <b>[次へ]</b> をクリックしてください。既存のインターネット アカウントを再確立しないで続けるには、<b>[省略]</b> をクリックしてください。";
