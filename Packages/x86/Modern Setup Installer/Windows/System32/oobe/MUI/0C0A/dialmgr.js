...
var L_REGSRV_Text      = "Su equipo se está conectando al servidor de registro.";
var L_ACTSRV_Text      = "Su equipo se está conectando al servidor de activación.";
var L_ACT_REG_SRV_Text = "Su equipo se está conectando al servidor de activación y registro.";
...
var L_PostToOEMandMS_Text = "Se marcará ahora un número de teléfono para registrar su equipo nuevo con Microsoft y %1. ";
var L_PostToMS_Text       = "Se marcará ahora un número de teléfono para registrar su equipo nuevo con Microsoft. ";
var L_PostToOEM_Text      = "Marcaremos un número de teléfono para registrar el equipo nuevo con %1. ";
var L_PrepToActRegOnline_Text  = "Preparándose para activar y registrar en línea";


var L_PrepToActReg_Text   = "Windows llamará a un número de teléfono para activar y registrar Windows con Microsoft.";
var L_PrepToActReg2_Text  = "Windows llamará a un número de teléfono para activar Windows con Microsoft y registrarse con %1. ";
var L_PrepToActReg3_Text  = "Windows llamará a un número de teléfono para activar y registrar Windows con Microsoft, y registrarse con %1. ";
var L_PrepToAct_Text      = "Windows marcará un número de teléfono para activar Windows a través de Microsoft.";
...
function RegDialRdy_LoadMe()
{
    ...
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater01_Text = " Re<u>c</u>ordármelo más tarde ";
...
var L_ConnectToOnlineAct_Text     = "Conectándose con activación en línea";
var L_ConnectToOnlineActReg_Text = "Conectándose con activación y registro en línea";
var L_ConnectToOnlineReg_Text     = "Conectando al registro en línea";
