...
var L_ERR_HN_UNAVAILABLE_Text = "Su equipo ya no está conectado a Internet a través de su red. <br><br>Para restablecer la conexión, asegúrese de que el cable de red está correctamente conectado al equipo así como a la red.";


var L_ERRSTOPPED_Text = "La Conexión compartida a Internet no está disponible actualmente en la red. Haga clic  en <b>Reintentar</b> para intentar conectar de nuevo.";
var L_ERR_PERM_DISCONNECTED_Text = "Se interrumpió la Conexión compartida a Internet. Si está utilizando un adaptador de alta velocidad para conectarse a Internet (por ejemplo, de banda ancha), asegúrese de que está correctamente configurado y de que los cables están firmemente conectados.<br><br>Haga clic en <b>Reintentar</b> para intentar conectar de nuevo.";
var L_ERRTIMEOUT_Text = "Error al conectar con Internet. O bien se superó el tiempo de espera para la conexión o este equipo no está configurado correctamente para utilizar la Conexión compartida a Internet. <br><br>Haga clic en <b>Reintentar</b> para intentar conectar de nuevo.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Su equipo no está conectado a Internet a través de su red. <br><br>Compruebe su configuración de red,  confirme que puede conectarse a Internet y vuelva a intentarlo.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Su equipo no está conectado a Internet a través de su red. <br><br>Seleccione uno de los siguientes métodos:";
