...
var L_EnterValidPhoneNumber_Text = "No se puede eliminar el número de teléfono completo.";
...
var L_altnumber_Text = "Marcar <u>e</u>ste número alternativo:";
var L_altnumber01_Text = "* Marcar <u>e</u>ste número alternativo:";
var L_outsideline_Text = "Incluir este número para tener acceso a la línea e<u>x</u>terna:";
var L_outsideline01_Text = "* Incluir este número para obtener una línea e<u>x</u>terna:";
var L_callwaiting_Text = "<u>D</u>eshabilitar llamada en espera:";
var L_callwaiting01_Text = "* <u>D</u>eshabilitar llamada en espera:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Para continuar sin realizar esta tarea, haga clic en <b>Recordármelo más tarde</b>.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " Recordármelo </u>m</u>ás tarde ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "El programa de instalación no se puede conectar a este número para activar y registrar su equipo.";
    var L_tbstr2_Text = "El programa de instalación no se puede conectar a este número para activar su equipo.";
    var L_tbstr3_Text = "El programa de instalación no se puede conectar a este número para registrar su equipo.";

    var L_tbstr4_Text = "Para continuar sin activar ni registrar el equipo, haga clic en <b>Omitir</b>.";
    var L_tbstr5_Text = "Para continuar sin activar el equipo, haga clic en <b>Omitir</b>.";
    var L_tbstr6_Text = "Para continuar sin registrar el equipo, haga clic en <b>Omitir</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "El registro y la activación en línea no están disponibles en su país o región. Para registrar su equipo sin conectarse a Internet, póngase en contacto con %1. Puede activar su copia de Windows utilizando una conexión a Internet o a través de Microsoft por teléfono.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "El registro y la activación en línea no están disponibles en su país o región. Puede activar su copia de Windows utilizando una conexión a Internet o a través de Microsoft por teléfono. Se necesita una conexión a Internet para registrar su copia de Windows con Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "La activación en línea no está disponible en su país o región. Puede activar su copia de Windows utilizando una conexión a Internet o a través de Microsoft por teléfono. Para registrar su equipo sin conectarse a Internet, póngase en contacto con %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "La activación en línea no está disponible en su país o región. Puede activar su copia de Windows utilizando una conexión a Internet o a través de Microsoft por teléfono.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "La activación en línea no está disponible en su país o región. Para registrar su equipo sin conectarse a Internet, póngase en contacto con %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
