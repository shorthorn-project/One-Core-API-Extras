...
var L_ERR_HN_UNAVAILABLE_Text = "Connessione a Internet tramite la rete non più disponibile. <br><br>Verificare che il cavo di rete sia connesso correttamente al computer e alla rete per ripristinare la connessione.";


var L_ERRSTOPPED_Text = "La Condivisione connessione Internet non è attualmente disponibile nella rete. Fare clic su <b>Riprova</b> per provare a eseguire nuovamente la connessione.";
var L_ERR_PERM_DISCONNECTED_Text = "La Condivisione connessione Internet è stata disconnessa. Se si utilizza una scheda ad alta velocità per la connessione a Internet (ad es. Broadband), verificare che la scheda sia stata configurata correttamente e che i cavi siano ben collegati.<br><br>Fare clic su <b>Riprova</b> per provare a eseguire nuovamente la connessione.";
var L_ERRTIMEOUT_Text = "Si è verificato un problema durante la connessione a Internet. È possibile che sia scaduto il tempo per la connessione oppure che il computer non sia configurato correttamente per utilizzare la Connessione a Internet condivisa. <br><br>Fare clic su <b>Riprova</b> per provare a eseguire nuovamente la connessione.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Il computer non è connesso a Internet tramite la rete. <br><br>Controllare le impostazioni di rete e confermare di essere in grado di connettersi a Internet, quindi riprovare.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Il computer non è connesso a Internet tramite la rete. <br><br>Selezionare uno dei seguenti metodi:";
