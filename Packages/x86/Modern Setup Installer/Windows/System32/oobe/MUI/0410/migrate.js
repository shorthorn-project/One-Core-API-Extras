...
var L_REF_STATUS_DIALING_Text           = "Chiamata in corso...";
var L_REF_STATUS_LOCATING_Text          = "Ricerca del servizio in corso";
var L_REF_STATUS_CONNECTING_Text        = "Connessione al servizio in corso";
var L_REF_STATUS_CONNECTED_Text         = "Connessione avvenuta";

var L_REF_STATUS_DOWNLOAD_Text          = "Download informazioni sui provider di servizi Internet in corso...";
var L_REFDIALTITLE_TEXT                 = "Ricerca di provider di servizi Internet locali in corso";
var L_REFDIALINTRO_TEXT                 = "È in corso il recupero di un elenco di provider di servizi Internet (ISP) locali per poter selezionare quello da utilizzare.";
...
var L_drdyref_2_ICS_Text = "Verrà ora utilizzata la connessione a Internet condivisa per impostare l'account Internet esistente in modo che sia possibile utilizzarlo con il nuovo computer";

var L_drdyref_4_ICS_Text = "Per continuare, fornire le informazioni richieste e fare clic su <b>Avanti</b>. Per continuare senza migrare l'account esistente, fare clic su <b>Ignora</b>.";

var L_drdymig_2_ICS_Text = "Verrà ora utilizzata la connessione a Internet condivisa per ripristinare l'account Internet esistente. &nbsp; Fare clic su <b>Avanti</b> per iniziare la connessione.";

var L_drdymig_4_ICS_Text = "Per continuare, fornire le informazioni richieste e fare clic su <b>Avanti</b>. Per continuare senza ripristinare l'account Internet esistente, fare clic su <b>Ignora</b>.";
