...
var L_EnterValidPhoneNumber_Text = "Kan ikke slette hele telefonnummeret.";
...
var L_altnumber_Text = "<u>R</u>ing dette alternative nummeret:";
var L_altnumber01_Text = "* <u>R</u>ing dette alternative nummeret:";
var L_outsideline_Text = "Inkluder dette nummeret for å få en <u>e</u>kstern linje:";
var L_outsideline01_Text = "* Inkluder dette nummeret for å få en <u>e</u>kstern linje:";
var L_callwaiting_Text = "Deaktiver <u>v</u>entefunksjon:";
var L_callwaiting01_Text = "* Deaktiver <u>v</u>entefunksjon:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Hvis du vil fortsette uten å utføre denne oppgaven, klikker du <b>Påminn meg senere</b>.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " Påminn <u>m</u>eg senere ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "Installasjonsprogrammet kan ikke koblet til dette telefonnummeret for å aktivere og registrere datamaskinen.";
    var L_tbstr2_Text = "Installasjonsprogrammet kan ikke koble til dette telefonnummeret for å aktivere datamaskinen.";
    var L_tbstr3_Text = "Installasjonsprogrammet kan ikke koble til dette telefonnummeret for å registrere datamaskinen.";

    var L_tbstr4_Text = "Hvis du vil fortsette uten å aktivere og registrere datamaskinen, klikker du <b>Hopp over</b>.";
    var L_tbstr5_Text = "Hvis du vil fortsette uten å aktivere datamaskinen, klikker du <b>Hopp over</b>.";
    var L_tbstr6_Text = "Hvis du vil fortsette uten å registrere datamaskinen, klikker du <b>Hopp over</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Elektronisk registrering og aktivering er for tiden utilgjengelig i landet eller området du befinner deg i. Hvis du vil registrere datamaskinen uten en Internett-tilkobling, kontakter du %1. Du kan aktivere Windows-eksemplaret ved hjelp av en Internett-tilkobling eller ved å ringe Microsoft.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Elektronisk registrering og aktivering er for tiden utilgjengelig i landet eller området du befinner deg i. Du kan aktivere Windows-eksemplaret ved hjelp av en Internett-tilkobling eller ved å ringe Microsoft. En Internett-tilkobling kreves for å registrere Windows-eksemplaret hos Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Elektronisk aktivering er for tiden utilgjengelig i landet eller området du befinner deg i. Du kan aktivere Windows-eksemplaret ved hjelp av en Internett-tilkobling eller ved å ringe Microsoft. Hvis du vil registrere datamaskinen uten en Internett-tilkobling, kontakter du %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "Elektronisk aktivering er for tiden utilgjengelig i landet eller området du befinner deg i. Du kan aktivere Windows-eksemplaret ved hjelp av en Internett-tilkobling eller ved å ringe Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Elektronisk registrering er for tiden utilgjengelig i landet eller området du befinner deg i. Hvis du vil registrere datamaskinen uten en Internett-tilkobling, kontakter du %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
