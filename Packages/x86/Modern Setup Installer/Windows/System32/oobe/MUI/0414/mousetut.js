...
var L_RewardStr1_Text="Bra jobb!";
var L_RewardStr2_Text="Det stemmer!";
var L_RewardStr3_Text="Du kan det!";
var L_RewardStr4_Text="Glimrende!";
var L_RewardStr5_Text="Det er så enkelt!";
var L_RewardStr6_Text="Fremragende!";
var L_RewardStr7_Text="Bravo!";
var L_RewardStr8_Text="Overveldende!";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "Start slo Rosenborg.";
