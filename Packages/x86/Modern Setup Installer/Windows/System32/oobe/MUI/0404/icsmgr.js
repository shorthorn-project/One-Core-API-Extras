...
var L_ERR_HN_UNAVAILABLE_Text = "您的電腦已不再透過您的網路連線到網際網路。 <br><br>如果要恢復連線，請確定網路線是否已正確連接到您的電腦及網路。";


var L_ERRSTOPPED_Text = "您網路上的網際網路連線共用目前無法使用。請按 <b>[重試]</b>，重新連線。";
var L_ERR_PERM_DISCONNECTED_Text = "網際網路連線共用已經中斷。如果使用高速介面卡來連接網際網路(例如寬頻)，請確定介面卡已經正確設定，而且纜線已經安全連接。<br><br>請按 <b>[重試]</b> 來重新連線。";
var L_ERRTIMEOUT_Text = "連線到網際網路發生問題。連線可能逾時，或這台電腦未正確設定來使用共用的網際網路連線。<br><br>請按 <b>[重試]</b>，重新連線。";
var L_ERR_LAN_UNAVAILABLE1_Text = "您的電腦並不是透過您的網路連線到網際網路。 <br><br>請檢查您的網路設定，並確認您可以連線到網際網路後，再重試一次。";
var L_ERR_LAN_UNAVAILABLE2_Text = "您的電腦並不是透過您的網路連線到網際網路。 <br><br>請選擇下列其中一種方法:";
