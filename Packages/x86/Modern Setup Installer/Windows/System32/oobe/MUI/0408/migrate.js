...
var L_REF_STATUS_DIALING_Text           = "Γίνεται κλήση...";
var L_REF_STATUS_LOCATING_Text          = "Υπηρεσία εντοπισμού";
var L_REF_STATUS_CONNECTING_Text        = "Γίνεται σύνδεση με την υπηρεσία";
var L_REF_STATUS_CONNECTED_Text         = "Έγινε σύνδεση";

var L_REF_STATUS_DOWNLOAD_Text          = "Γίνεται λήψη πληροφοριών ISP...";
var L_REFDIALTITLE_TEXT                 = "Γίνεται εύρεση υπηρεσιών παροχής Internet στην περιοχή σας";
var L_REFDIALINTRO_TEXT                 = "H Microsoft ανακτά μια λίστα με υπηρεσίες παροχής Internet (ISP) στην περιοχή σας, ώστε να μπορέσετε να επιλέξετε αυτήν που θέλετε να χρησιμοποιήσετε.";
...
var L_drdyref_2_ICS_Text = "Τα Windows θα χρησιμοποιήσουν τώρα την Κοινόχρηστη σύνδεση στο Internet για να μετεγκαταστήσουν τη ρύθμιση του ήδη υπάρχοντος λογαριασμού σας Internet, έτσι ώστε να μπορείτε να τον χρησιμοποιήσετε με τον νέο σας υπολογιστή";

var L_drdyref_4_ICS_Text = "Για να συνεχίσετε, δώστε τις παρακάτω πληροφορίες και κάντε κλικ στο κουμπί <b>Επόμενο</b>. Για να συνεχίσετε χωρίς να κάνετε μετεγκατάσταση ενός υπάρχοντος λογαριασμού, κάντε κλικ στο κουμπί <b>Παράλειψη</b>.";

var L_drdymig_2_ICS_Text = "Τα Windows θα χρησιμοποιήσουν τώρα την Κοινόχρηστη σύνδεση στο Internet για να ξεκινήσουν πάλι την ενεργοποίηση του ήδη υπάρχοντος λογαριασμού σας Internet. &nbsp; Κάντε κλικ στο κουμπί <b>Επόμενο</b>, για να ξεκινήσετε τη σύνδεση.";

var L_drdymig_4_ICS_Text = "Για να συνεχίσετε, δώστε τις παρακάτω πληροφορίες και κάντε κλικ στο κουμπί <b>Επόμενο</b>. Για να συνεχίσετε χωρίς να ενεργοποιήσετε πάλι έναν ήδη υπάρχοντα λογαριασμό Internet, κάντε κλικ στο κουμπί <b>Παράλειψη</b>.";
