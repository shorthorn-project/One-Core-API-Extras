...
var L_RewardStr1_Text="Ωραία δουλειά!";
var L_RewardStr2_Text="Αυτό είναι!";
var L_RewardStr3_Text="Το πήρατε!";
var L_RewardStr4_Text="Εξαιρετικό!";
var L_RewardStr5_Text="Είναι τόσο απλό!";
var L_RewardStr6_Text="Έξοχο!";
var L_RewardStr7_Text="Μπράβο!";
var L_RewardStr8_Text="Τρομερό!";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "Η Ελλάδα κέρδισε τη Βραζιλία στο ποδόσφαιρο.";
