...
var L_REF_STATUS_DIALING_Text           = "Ringer upp...";
var L_REF_STATUS_LOCATING_Text          = "Söker efter tjänst";
var L_REF_STATUS_CONNECTING_Text        = "Ansluter till tjänst";
var L_REF_STATUS_CONNECTED_Text         = "Ansluten";

var L_REF_STATUS_DOWNLOAD_Text          = "Hämtar information om Internet-leverantörer...";
var L_REFDIALTITLE_TEXT                 = "Söker Internet-leverantörer i ditt område";
var L_REFDIALINTRO_TEXT                 = "Microsoft hämtar en lista på Internet-leverantörer i ditt område så att du kan välja den du vill använda.";
...
var L_drdyref_2_ICS_Text = "Windows använder nu den delade Internet-anslutningen för att flytta ditt befintliga Internet-konto så att du kan använda det på den nya datorn";

var L_drdyref_4_ICS_Text = "Om du vill fortsätta anger du informationen nedan och klickar på <b>Nästa</b>. Om du vill fortsätta utan att flytta ett befintligt konto klickar du på <b>Hoppa över</b>.";

var L_drdymig_2_ICS_Text = "Windows använder nu den delade Internet-anslutningen för att börja återupprätta ditt befintliga Internet-konto. &nbsp; Klicka på <b>Nästa</b> om du vill börja ansluta.";

var L_drdymig_4_ICS_Text = "Om du vill fortsätta anger du informationen nedan och klickar på <b>Nästa</b>. Om du vill fortsätta utan att återupprätta ett befintligt Internet-konto klickar du på <b>Hoppa över</b>.";
