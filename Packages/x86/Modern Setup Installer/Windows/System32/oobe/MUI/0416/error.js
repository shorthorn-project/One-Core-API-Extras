...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr4_Text = "Para continuar sem fazer a ativação e registrar o computador, clique em <b>Ignorar</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "O registro e a ativação on-line não estão disponíveis no momento em seu país ou região. Para registrar o computador sem uma conexão com a Internet, contate %1. Você pode ativar sua cópia do Windows usando uma conexão com a Internet ou contatando a Microsoft pelo telefone.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "No momento, o registro e a ativação on-line não estão disponíveis em seu país ou região. Você pode ativar sua cópia do Windows pela Internet ou entrando em contato com a Microsoft por telefone. É necessário se conectar à Internet para registrar a sua cópia do Windows na Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "No momento, a ativação on-line não está disponível em seu país ou região. Você pode ativar sua cópia do Windows pela Internet ou entrando em contato com a Microsoft por telefone. Para registrar o computador sem ter que se conectar à Internet, contate %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "No momento, a ativação on-line não está disponível em seu país ou região. Você pode ativar sua cópia do Windows pela Internet ou entrando em contato com a Microsoft por telefone.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "O registro on-line não está disponível no momento em seu país ou região. Para registrar o computador sem uma conexão com a Internet, contate %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
