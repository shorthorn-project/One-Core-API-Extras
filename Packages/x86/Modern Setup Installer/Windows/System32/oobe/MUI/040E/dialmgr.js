...
var L_REGSRV_Text      = "A számítógép most teremt kapcsolatot a regisztrációs kiszolgálóval.";
var L_ACTSRV_Text      = "A számítógép most teremt kapcsolatot az aktiválási kiszolgálóval.";
var L_ACT_REG_SRV_Text = "A számítógép most teremt kapcsolatot az aktiválási és regisztrációs kiszolgálóval.";

var L_REGCOM_Text      = "A Windows regisztrálása... ";
var L_REGCOM2_Text     = "A számítógép regisztrálása... ";
var L_ACTCOM_Text      = "A Windows aktiválása... ";
var L_ACTREGCOM_Text   = "A Windows aktiválása és regisztrálása... ";
...
var L_PostToOEMandMS_Text = "Most felhívunk egy telefonszámot, és regisztráljuk új számitógépét a Microsoft és a(z) %1 nyilvántartásában.";
var L_PostToMS_Text       = "Most egy telefonszám felhívásával regisztráljuk az új számítógépet a Microsoftnál. ";
var L_PostToOEM_Text      = "Most fel fogunk hívni egy telefonszámot, hogy regisztráljuk új számítógépét a(z) %1 nyilvántartásában.";
var L_PrepToActRegOnline_Text  = "Felkészülés az internetes aktiválásra és regisztrálásra";


var L_PrepToActReg_Text   = "A Windows most felhív egy telefonszámot, így aktiválhatja és regisztráltathatja a terméket a Microsoftnál.";
var L_PrepToActReg2_Text  = "A Windows most felhívni egy telefonszámot, hogy aktiválja a Windows rendszert a Microsoftnál, és regisztrálja a(z) %1 nyilvántartásában. ";
var L_PrepToActReg3_Text  = "A Windows most felhív egy telefonszámot, hogy aktiválja és regisztrálja a Windows rendszert a Microsoftnál, és regisztrálja a(z) %1 nyilvántartásában.";
var L_PrepToAct_Text      = "A Windows most felhív egy telefonszámot, hogy aktiválja a Windowst a Microsoftnál.";
...
function RegDialRdy_LoadMe()
{
    ...
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater01_Text = " <u>E</u>mlékeztessen késõbb ";
...
var L_ConnectToOnlineAct_Text     = "Kapcsolódás az internetes aktiválási szolgáltatáshoz";
var L_ConnectToOnlineActReg_Text = "Kapcsolódás az internetes aktiválási és regisztrációs szolgáltatáshoz";
var L_ConnectToOnlineReg_Text     = "Hálózati regisztráció - csatlakozás";
