...
var L_REGSRV_Text      = "Выполняется подключение к серверу регистрации.";
var L_ACTSRV_Text      = "Выполняется подключение к серверу активации.";
var L_ACT_REG_SRV_Text = "Выполняется подключение к серверу активации и регистрации.";

var L_REGCOM_Text      = "Регистрация  Windows... ";
var L_REGCOM2_Text     = "Регистрация компьютера... ";
var L_ACTCOM_Text      = "Активация Windows... ";
var L_ACTREGCOM_Text   = "Активация и регистрация Windows... ";
...
var L_PostToOEMandMS_Text = "Будет набран номер телефона службы регистрации нового компьютера в корпорации Майкрософт и %1. ";
var L_PostToMS_Text       = "Будет набран номер телефона регистрации нового компьютера в корпорации Майкрософт. ";
var L_PostToOEM_Text      = "Будет набран номер телефона регистрации нового компьютера в %1. ";
var L_PrepToActRegOnline_Text  = "Регистрация и активация через Интернет";


var L_PrepToActReg_Text   = "Windows наберет номер телефона для активации и регистрации вашей копии Windows в корпорации Майкрософт.";
var L_PrepToActReg2_Text  = "Windows наберет номер телефона для активации  вашей копии Windows в корпорации Майкрософт и регистрации ее в %1. ";
var L_PrepToActReg3_Text  = "Windows наберет номер телефона для активации  вашей копии Windows в корпорации Майкрософт и регистрации ее в %1. ";
var L_PrepToAct_Text      = "Windows наберет номер телефона для активации вашей копии программного продукта в корпорации Майкрософт.";
...
var L_ConnectToOnlineAct_Text     = "Подключение к центру активации через Интернет";
var L_ConnectToOnlineActReg_Text = "Подключение к центру активации и регистрации через Интернет";
var L_ConnectToOnlineReg_Text     = "Подключение к узлу регистрации через Интернет";
