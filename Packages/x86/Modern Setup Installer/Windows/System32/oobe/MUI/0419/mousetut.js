...
var L_RewardStr1_Text="Замечательно!";
var L_RewardStr2_Text="Готово!";
var L_RewardStr3_Text="Получилось!";
var L_RewardStr4_Text="Превосходно!";
var L_RewardStr5_Text="Это так просто!";
var L_RewardStr6_Text="Замечательно!";
var L_RewardStr7_Text="Браво!";
var L_RewardStr8_Text="Изумительно!";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "Команда Steelers из Питтсбурга проигрывает команде Seahawks из Сиэтла.";
