...
var L_RewardStr1_Text="Hyvä.";
var L_RewardStr2_Text="Oikein.";
var L_RewardStr3_Text="Nyt se sujuu hyvin.";
var L_RewardStr4_Text="Hienoa.";
var L_RewardStr5_Text="Noin helppoa se on.";
var L_RewardStr6_Text="Loistavaa.";
var L_RewardStr7_Text="Bravo.";
var L_RewardStr8_Text="Erinomaista.";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "Tappara voitti Tepsin 6-0!";
