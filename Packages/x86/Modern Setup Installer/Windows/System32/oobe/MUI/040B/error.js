...
var L_altnumber_Text = "<u>V</u>alitse vaihtoehtoinen numero:";
var L_altnumber01_Text = "* <u>V</u>alitse vaihtoehtoinen numero:";
var L_outsideline_Text = "<u>U</u>lkolinjan valintanumero on:";
var L_outsideline01_Text = "* <u>U</u>lkolinjan valintanumero on:";
var L_callwaiting_Text = "Poista <u>k</u>oputustoiminto käytöstä valitsemalla:";
var L_callwaiting01_Text = "* Poista <u>k</u>oputustoiminto käytöstä valitsemalla:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater01_Text = " M<u>u</u>istuta myöhemmin ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "Asennusohjelma ei voi muodostaa tietokoneen aktivoimiseen ja rekisteröimiseen vaadittavaa yhteyttä tähän numeroon.";
    var L_tbstr2_Text = "Tähän numeroon yhdistäminen ei onnistu.";
    var L_tbstr3_Text = "Asennusohjelma ei voi muodostaa tietokoneen rekisteröimiseen vaadittavaa yhteyttä tähän numeroon.";

    var L_tbstr4_Text = "Voit jatkaa aktivoimatta ja rekisteröimättä tietokonettasi valitsemalla <b>Ohita</b>.";
    var L_tbstr5_Text = "Jatka ilman tietokoneen aktivointia valitsemalla <b>Ohita</b>.";
    var L_tbstr6_Text = "Jos haluat jatkaa ilman tietokoneen rekisteröintiä, valitse <b>Ohita</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Online-rekisteröinti ja -aktivointi ei ole käytettävissä maassasi tai asuinalueellasi. Voit rekisteröidä tietokoneesi ilman Internet-yhteyttä ottamalla yhteyttä numeroon %1. Voit aktivoida Windowsin Internet-yhteyden avulla tai puhelimitse.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Alueellasi ei voi tällä hetkellä tehdä online-aktivointia tai rekisteröintiä. Voit aktivoida Windowsin myöhemmin Internet-yhteyden tai ottamalla yhteyttä Microsoftiin puhelimella. Rekisteröintiin vaaditaan Internet-yhteys.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Alueellasi ei voi tällä hetkellä tehdä online-aktivointia. Voit aktivoida Windowsin myöhemmin Internet-yhteyden tai ottamalla yhteyttä Microsoftiin puhelimella. %1 voi neuvoa tietokoneen rekisteröinnissä ilman Internet-yhteyttä. ";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "Alueellasi ei voi tällä hetkellä tehdä online-aktivointia. Voit aktivoida Windowsin myöhemmin Internet-yhteyden tai ottamalla yhteyttä Microsoftiin puhelimella.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Online-rekisteröinti ja -aktivointi ei ole käytettävissä maassasi tai asuinalueellasi. Voit rekisteröidä tietokoneesi ilman Internet-yhteyttä ottamalla yhteyttä numeroon %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
