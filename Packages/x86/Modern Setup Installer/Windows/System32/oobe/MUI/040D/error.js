...
var L_EnterValidPhoneNumber_Text = "אין אפשרות למחוק מספר טלפון שלם.";
...
var L_altnumber_Text = "<u>ח</u>ייג מספר חלופי זה:";
var L_altnumber01_Text = "* <u>ח</u>ייג מספר חלופי זה:";
var L_outsideline_Text = "כלול מספר זה ל<u>ק</u>בלת קו חוץ:";
var L_outsideline01_Text = "* כלול מספר זה ל<u>ק</u>בלת קו חוץ:";
var L_callwaiting_Text = "בטל <u>ש</u>יחה ממתינה:";
var L_callwaiting01_Text = "* בטל <u>ש</u>יחה ממתינה:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "כדי להמשיך מבלי לבצע משימה זו, לחץ על <b>הזכר לי מאוחר יותר</b>.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " הזכר לי <u>מ</u>אוחר יותר ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "לתוכנית ההתקנה אין אפשרות להתקשר למספר זה לשם הפעלה ורישום של המחשב שלך.";
    var L_tbstr2_Text = "לתוכנית ההתקנה אין אפשרות להתקשר למספר זה לשם הפעלת המחשב שלך.";
    var L_tbstr3_Text = "לתוכנית ההתקנה אין אפשרות להתקשר למספר זה לשם רישום המחשב שלך.";

    var L_tbstr4_Text = "כדי להמשיך ללא הפעלה ורישום של המחשב שלך, לחץ על <b>דלג</b>.";
    var L_tbstr5_Text = "כדי להמשיך ללא הפעלת המחשב שלך, לחץ על <b>דלג</b>.";
    var L_tbstr6_Text = "כדי להמשיך ללא רישום המחשב שלך, לחץ על <b>דלג</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "רישום והפעלה מקוונים אינם זמינים כעת במדינה או באזור שלך. כדי לבצע רישום של המחשב שלך ללא חיבור לאינטרנט, נא צור קשר עם %1. באפשרותך לבצע הפעלה של עותק Windows שברשותך באמצעות חיבור אינטרנט או על-ידי יצירת קשר עם Microsoft באמצעות הטלפון.";
        ...
        {
            g.Title_Text.innerText = "‏‏אין אפשרות לבצע הפעלה ורישום מקוונים";
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "רישום והפעלה מקוונים אינם זמינים כעת במדינה או באזור שלך. באפשרותך לבצע הפעלה של עותק Windows שברשותך באמצעות חיבור אינטרנט או על-ידי יצירת קשר עם Microsoft באמצעות הטלפון. לשם רישום של עותק Windows שברשותך ב- Microsoft, נחוץ חיבור אינטרנט.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "הפעלה מקוונת אינה זמינה כעת במדינה או באזור שלך. באפשרותך לבצע הפעלה של עותק Windows שברשותך באמצעות חיבור אינטרנט או על-ידי יצירת קשר עם Microsoft באמצעות הטלפון. לשם רישום של המחשב ללא חיבור אינטרנט, נא צור קשר עם %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            g.Title_Text.innerText = "אין אפשרות לבצע הפעלה מקוונת";
            GetPageTitle();
            
            L_DeskMainPBerrMsg_Text        = "הפעלה מקוונת אינה זמינה כעת במדינה או באזור שלך. באפשרותך לבצע הפעלה של עותק Windows שברשותך באמצעות חיבור אינטרנט או על-ידי יצירת קשר עם Microsoft באמצעות הטלפון.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            g.Title_Text.innerText = "אין אפשרות לבצע רישום מקוון";
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "רישום מקוון אינו זמין כעת במדינה או באזור שלך. כדי לרשום את המחשב שלך ללא חיבור לאינטרנט, נא צור קשר עם %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
