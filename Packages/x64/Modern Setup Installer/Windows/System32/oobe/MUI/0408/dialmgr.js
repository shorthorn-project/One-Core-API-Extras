...
var L_REGSRV_Text      = "Ο υπολογιστής σας συνδέεται με τον διακομιστή δήλωσης.";
var L_ACTSRV_Text      = "Ο υπολογιστής σας συνδέεται στο κέντρο ενεργοποίησης.";
var L_ACT_REG_SRV_Text = "Ο υπολογιστής σας συνδέεται με τον διακομιστή δήλωσης και ενεργοποίησης.";

var L_REGCOM_Text      = "Γίνεται δήλωση των Windows... ";
var L_REGCOM2_Text     = "Δήλωση του υπολογιστή σας... ";
var L_ACTCOM_Text      = "Γίνεται ενεργοποίηση των Windows... ";
var L_ACTREGCOM_Text   = "Γίνεται ενεργοποίηση και δήλωση των Windows... ";
...
var L_PostToOEMandMS_Text = "Τώρα θα καλέσουμε έναν αριθμό τηλεφώνου για να δηλώσουμε τον νέο υπολογιστή σας στη Microsoft και στη %1. ";
var L_PostToMS_Text       = "Τώρα θα καλέσουμε έναν αριθμό τηλεφώνου για να δηλώσουμε τον νέο υπολογιστή σας στη Microsoft. ";
var L_PostToOEM_Text      = "Τώρα θα καλέσουμε έναν αριθμό τηλεφώνου για να δηλώσουμε τον νέο υπολογιστή σας στη %1. ";
var L_PrepToActRegOnline_Text  = "Γίνεται προετοιμασία για ηλεκτρονική ενεργοποίηση και δήλωση";


var L_PrepToActReg_Text   = "Τα Windows θα καλέσουν τώρα έναν αριθμό τηλεφώνου για να κάνουν ενεργοποίηση και δήλωση των Windows στη Microsoft.";
var L_PrepToActReg2_Text  = "Τα Windows θα καλέσουν τώρα έναν αριθμό τηλεφώνου για να κάνουν ενεργοποίηση των Windows στη Microsoft και δήλωση στη %1. ";
var L_PrepToActReg3_Text  = "Τα Windows θα καλέσουν τώρα έναν αριθμό τηλεφώνου για την ενεργοποίηση και δήλωση των Windows στη Microsoft και την εγγραφή στο %1. ";
var L_PrepToAct_Text      = "Τα Windows θα κάνουν τώρα κλήση σε έναν αριθμό τηλεφώνου για ενεργοποίηση των Windows στη Microsoft.";
...
function RegDialRdy_LoadMe()
{
    ...
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater01_Text = " Υπενθύ<u>μ</u>ιση αργότερα ";
        var AccesskeyRemind_M = "Μ";
...
var L_ConnectToOnlineAct_Text     = "Γίνεται σύνδεση στην ηλεκτρονική ενεργοποίηση";
var L_ConnectToOnlineActReg_Text = "Γίνεται σύνδεση στην ηλεκτρονική ενεργοποίηση και δήλωση";
var L_ConnectToOnlineReg_Text     = "Γίνεται σύνδεση για ηλεκτρονική δήλωση";
