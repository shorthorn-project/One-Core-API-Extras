...
var L_StaticIpAddress_Text  = "静的 IP アドレス(<U>T</U>):";
var L_StaticIpAddress2_Text = "* 静的 IP アドレス(<U>T</U>):";
var L_SubnetMask_Text       = "サブネット マスク(<U>U</U>):";
var L_SubnetMask2_Text      = "* サブネット マスク(<U>U</U>):";
var L_Defaultgateway_Text   = "デフォルト ゲートウェイ(<U>E</U>):";
var L_Defaultgateway2_Text  = "* デフォルト ゲートウェイ(<U>E</U>):";
var L_YourUsername_Text     = "ユーザー名(<U>U</U>):";
var L_YourUsername2_Text    = "* ユーザー名(<U>U</U>):";
var L_PreferredDNS_Text     = "優先 DNS(<U>P</U>):";
var L_PreferredDNS2_Text    = "* 優先 DNS(<U>P</U>):";
var L_AlternateDNS_Text     = "代替 DNS(<U>A</U>):";
var L_AlternateDNS2_Text    = "* 代替 DNS(<U>A</U>):";
