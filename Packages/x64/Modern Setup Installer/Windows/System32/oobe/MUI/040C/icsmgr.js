...
var L_ERR_HN_UNAVAILABLE_Text = "Votre ordinateur n'est plus connecté à Internet via votre réseau.<br><br>Pour restaurer la connexion, vérifiez que le câble réseau est correctement raccordé à l'ordinateur ainsi qu'au réseau.";


var L_ERRSTOPPED_Text = "Le Partage de connexion Internet n'est pas disponible actuellement sur votre réseau. Cliquez sur <b>Recommencer</b> pour tenter de vous reconnecter.";
var L_ERR_PERM_DISCONNECTED_Text = "Le Partage de connexion Internet a été déconnecté. Si vous utilisez une carte grande vitesse pour vous connecter à Internet (par ex. une carte large bande), vérifiez qu'elle est correctement configurée et que les câbles sont bien reliés.<br><br>Cliquez sur <b>Recommencer</b> pour tenter de vous reconnecter.";
var L_ERRTIMEOUT_Text = "Problème de connexion à Internet. Le délai de votre connexion a expiré, ou cet ordinateur n'est pas correctement configuré pour utiliser le Partage de connexion Internet. <br><br>Cliquez sur <b>Recommencer</b> pour tenter de vous reconnecter.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Votre ordinateur n'est pas connecté à Internet via votre réseau. <br><br>Vérifiez vos paramètres réseau et tentez de vous connecter à Internet, puis recommencez.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Votre ordinateur n'est pas connecté à Internet via votre réseau. <br><br>Choisissez l'une des méthodes suivantes :";
