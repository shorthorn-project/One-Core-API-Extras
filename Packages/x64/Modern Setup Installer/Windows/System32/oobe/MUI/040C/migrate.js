...
var L_REF_STATUS_DIALING_Text           = "Numérotation...";
var L_REF_STATUS_LOCATING_Text          = "Recherche du service";
var L_REF_STATUS_CONNECTING_Text        = "Connexion au service";
var L_REF_STATUS_CONNECTED_Text         = "Connecté";

var L_REF_STATUS_DOWNLOAD_Text          = "Téléchargement des informations sur les fournisseurs de services Internet...";
var L_REFDIALTITLE_TEXT                 = "Recherche de fournisseurs de services Internet dans votre région";
var L_REFDIALINTRO_TEXT                 = "Microsoft récupère une liste de fournisseurs de services Internet dans votre région afin que vous puissiez sélectionner celui que vous voulez utiliser.";
...
var L_drdyref_2_ICS_Text = "Windows va maintenant utiliser votre connexion Internet partagée pour migrer vers votre configuration de compte existant ; de cette façon, vous pourrez l'utiliser avec votre nouvel ordinateur";

var L_drdyref_4_ICS_Text = "Pour continuer, indiquez les informations ci-dessous et cliquez sur <b>Suivant</b>. Pour continuer sans migrer un compte existant, cliquez sur <b>Ignorer</b>.";

var L_drdymig_2_ICS_Text = "Windows va maintenant utiliser votre connexion Internet partagée pour commencer à rétablir votre compte Internet existant. &nbsp; Cliquez sur <b>Suivant</b> pour démarrer la connexion.";

var L_drdymig_4_ICS_Text = "Pour continuer, indiquez les informations ci-dessous et cliquez sur <b>Suivant</b>. Pour continuer sans rétablir un compte existant, cliquez sur <b>Ignorer</b>.";
