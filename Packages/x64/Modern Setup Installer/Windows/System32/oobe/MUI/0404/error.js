...
var L_EnterValidPhoneNumber_Text = "無法刪除全部的電話號碼。";
...
var L_altnumber_Text = "請撥這個其他號碼(<u>D</u>):";
var L_altnumber01_Text = "* 請撥這個其他號碼(<u>D</u>):";
var L_outsideline_Text = "包含這個號碼以撥接外線(<u>O</u>):";
var L_outsideline01_Text = "* 包含這個號碼以撥接外線(<u>O</u>):";
var L_callwaiting_Text = "停用電話插撥功能(<u>C</u>):";
var L_callwaiting01_Text = "* 停用電話插撥功能(<u>C</u>):";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "如果要繼續而不執行這個工作，請按 <b>[稍後再提醒我]</b>。";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " 稍後再提醒我(<u>M</u>)";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "安裝程式無法連線到這個號碼，來啟用及註冊您的電腦。";
    var L_tbstr2_Text = "安裝程式無法連線到這個號碼，來啟用您的電腦。";
    var L_tbstr3_Text = "安裝程式無法連線到這個號碼，來註冊您的電腦。";

    var L_tbstr4_Text = "如果要繼續而不啟用及註冊您的電腦，請按 <b>[跳過]</b>。";
    var L_tbstr5_Text = "如果要繼續而不啟用您的電腦，請按 <b>[跳過]</b>。";
    var L_tbstr6_Text = "如果要繼續而不註冊您的電腦，請按 <b>[跳過]</b>。";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "您的國家或地區目前無法進行線上註冊及啟用。如果您不想透過網際網路連線註冊您的電腦，請連絡 %1。您可以使用網際網路連線，或打電話給 Microsoft，來啟用您的 Windows。";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "您的國家或地區目前無法進行線上註冊及啟用。您可以使用網際網路連線，或打電話給 Microsoft，來啟用您的 Windows。必須要有網際網路連線，才能向 Microsoft 註冊您的 Windows。";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "您的國家或地區目前無法進行線上啟用。您可以使用網際網路連線，或打電話給 Microsoft，來啟用您的 Windows。如果您不想透過網際網路連線註冊您的電腦，請連絡 %1。";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "您的國家或地區目前無法進行線上啟用。您可以使用網際網路連線，或打電話給 Microsoft，來啟用您的 Windows。";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "您的國家或地區目前無法進行線上註冊。如果您不想透過網際網路連線註冊您的電腦，請連絡 %1。";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
