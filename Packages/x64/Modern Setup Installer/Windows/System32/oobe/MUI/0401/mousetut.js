...
var L_RewardStr1_Text="Úãá ÌíÏ!";
var L_RewardStr2_Text="æåæ ÇáãØáæÈ!";
var L_RewardStr3_Text="ÃÍÓäÊ!";
var L_RewardStr4_Text="ããÊÇÒ!";
var L_RewardStr5_Text="íÇ ááÓåæáÉ!";
var L_RewardStr6_Text="ÑÇÆÚ!";
var L_RewardStr7_Text="ãÑÍì!";
var L_RewardStr8_Text="ãĞåá!";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "İÇÒ Seattle Seahawks Úáì İÑíŞ Steelers.";
