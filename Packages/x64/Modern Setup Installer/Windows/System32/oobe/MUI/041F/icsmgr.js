...
var L_ERR_HN_UNAVAILABLE_Text = "Bilgisayarýnýz artýk Internet'e aðýnýz üzerinden baðlý deðil. <br><br>Baðlantýyý geri yüklemek için, að kablonuzun aðýn yaný sýra bilgisayarýnýza da doðru biçimde takýldýðýndan emin olun.";


var L_ERRSTOPPED_Text = "Internet Baðlantý Paylaþýmý þu anda aðýnýzda kullanýlamýyor olabilir. Yeniden baðlanmaya çalýþmak için <b>Yeniden Dene</b>'yi týklatýn.";
var L_ERR_PERM_DISCONNECTED_Text = "Internet Baðlantý Paylaþýmý'nýn baðlantýsý kesildi. Internet'e baðlanmak için yüksek hýzlý bir baðdaþtýrýcý kullanýyorsanýz, (Broadband gibi), baðdaþtýrýcýnýn doðru yapýlandýrýldýðýndan ve kablonun doðru baðlandýðýndan emin olun.<br><br>Yeniden baðlanmaya çalýþmak için <b>Yeniden Dene</b>'yi týklatýn.";
var L_ERRTIMEOUT_Text = "Internet'e baðlanmayla ilgili bir sorun var. Bilgisayarýnýzýn baðlantýsý zaman aþýmýna uðramýþ ya da bilgisayarýnýzý Internet Baðlantý Paylaþýmýný kullanmak için doðru yapýlandýrýlmamýþ. <br><br>Yeniden baðlanmaya çalýþmak için <b>Yeniden Dene</b>'yi týklatýn.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Bilgisayarýnýz Internet'e aðýnýz üzerinden baðlý deðil. <br><br>Lütfen að ayarlarýnýzý denetleyin ve Internet'e baðlanabildiðinizi doðrulayýn, ardýndan yeniden deneyin.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Bilgisayarýnýz Internet'e aðýnýz üzerinden baðlý deðil. <br><br>Lütfen aþaðýdaki yöntemlerden birini seçin:";
