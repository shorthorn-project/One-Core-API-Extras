...
var L_RewardStr1_Text="כל הכבוד!";
var L_RewardStr2_Text="ככה בדיוק!";
var L_RewardStr3_Text="תפסת את זה!";
var L_RewardStr4_Text="מצוין!";
var L_RewardStr5_Text="זה כל כך פשוט!";
var L_RewardStr6_Text="יוצא מן הכלל!";
var L_RewardStr7_Text="בראבו!";
var L_RewardStr8_Text="נהדר!";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "מכבי תל-אביב ניצחה את הפועל גליל עליון.";
