...
var L_REGSRV_Text      = "המחשב מתחבר לשרת הרישום.";
var L_ACTSRV_Text      = "המחשב מתחבר לשרת ההפעלה.";
var L_ACT_REG_SRV_Text = "המחשב מתחבר לשרת ההפעלה והרישום.";

var L_REGCOM_Text      = "מבצע רישום של Windows... ";
var L_REGCOM2_Text     = "מבצע רישום של המחשב שלך...";
var L_ACTCOM_Text      = "מבצע הפעלה של Windows... ";
var L_ACTREGCOM_Text   = "מבצע הפעלה ורישום של Windows... ";
...
var L_PostToOEMandMS_Text = "נחייג כעת מספר טלפון כדי לרשום את המחשב החדש שלך אצל Microsoft ואצל %1. ";
var L_PostToMS_Text       = "נחייג כעת מספר כדי לרשום את המחשב החדש שלך עם Microsoft. ";
var L_PostToOEM_Text      = "נחייג כעת מספר טלפון כדי לרשום את המחשב החדש שלך אצל %1. ";
var L_PrepToActRegOnline_Text  = "מתכונן להפעלה ולרישום באופן מקוון";


var L_PrepToActReg_Text   = "Windows יחייג כעת מספר טלפון כדי לבצע הפעלה ורישום של Windows ב- Microsoft.";
var L_PrepToActReg2_Text  = "Windows יחייג כעת מספר טלפון כדי לבצע הפעלה של Windows מול Microsoft ולבצע רישום ב- %1. ";
var L_PrepToActReg3_Text  = "Windows יחייג כעת מספר טלפון כדי לבצע הפעלה ורישום של Windows ב- Microsoft ולבצע רישום ב- %1. ";
var L_PrepToAct_Text      = "Windows יחייג כעת מספר טלפון כדי לבצע הפעלה של Windows ב- Microsoft.";
...
var L_ConnectToOnlineAct_Text     = "מתקשר להפעלה מקוונת";
var L_ConnectToOnlineActReg_Text = "מתקשר להפעלה ורישום מקוונים";
var L_ConnectToOnlineReg_Text     = "מתקשר לרישום מקוון";
