...
var L_ERR_HN_UNAVAILABLE_Text = "המחשב שלך אינו מחובר עוד לאינטרנט באמצעות הרשת. <br><br>כדי לשחזר את החיבור, ודא שכבל הרשת מחובר היטב למחשב ולרשת.";


var L_ERRSTOPPED_Text = "שיתוף התקשרויות לאינטרנט אינו זמין כעת ברשת שלך. לחץ על <b>נסה שנית</b> כדי לנסות שוב ליצור התקשרות.";
var L_ERR_PERM_DISCONNECTED_Text = "שירות שיתוף התקשרויות לאינטרנט נותק. אם אתה משתמש במתאם במהירות גבוהה לשם התקשרות לאינטרנט (לדוגמה, פס רחב), נא ודא כי תצורת המתאם הוגדרה כהלכה וכי הכבלים מחוברים כראוי.<br><br>לחץ על <b>נסה שנית</b> כדי לנסות שוב ליצור התקשרות.";
var L_ERRTIMEOUT_Text = "קיימת בעיה בהתקשרות לאינטרנט. ייתכן שמשך הזמן שהוקצב להתקשרות חלף, או שתצורת מחשב זה לא הוגדרה כראוי לשימוש בהתקשרות המשותפת לאינטרנט. <br><br>לחץ על <b>נסה שנית</b> כדי לנסות שוב ליצור התקשרות.";
var L_ERR_LAN_UNAVAILABLE1_Text = "המחשב שלך אינו מחובר עוד לאינטרנט באמצעות הרשת של. <br><br>נא בדוק את הגדרות הרשת וודא שאתה יכול להתחבר לאינטרנט ואז נסה שנית.";
var L_ERR_LAN_UNAVAILABLE2_Text = "המחשב שלך אינו מחובר לאינטרנט באמצעות הרשת שלך. <br><br>נא בחר אחד מהשיטות הבאות:";
