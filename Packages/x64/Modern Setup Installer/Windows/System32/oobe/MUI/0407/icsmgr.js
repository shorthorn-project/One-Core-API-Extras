...
var L_ERR_HN_UNAVAILABLE_Text = "Es besteht keine Internetverbindung über das Netzwerk. <br><br>Vergewissern Sie sich, dass das Netzwerkkabel richtig angeschlossen ist, um die Verbindung wiederherzustellen.";


var L_ERRSTOPPED_Text = "Internetverbindungsfreigabe ist zurzeit nicht in Ihrem Netzwerk verfügbar. Klicken Sie auf <b>Wiederholen</b>, um erneut eine Verbindung herzustellen.";
var L_ERR_PERM_DISCONNECTED_Text = "Die Internetverbindungsfreigabe wurde getrennt. Wenn Sie einen Adapter mit hohen Übertragungsraten (z. B. Breitband) für die Verbindung mit dem Internet verwenden, stellen Sie sicher, dass der Adapter richtig konfiguriert ist und dass die Kabel sicher angebracht sind.<br><br>Klicken Sie auf <b>Wiederholen</b>, um erneut eine Verbindung herzustellen.";
var L_ERRTIMEOUT_Text = "Problem bei der Verbindung mit dem Internet. Entweder wurde das Zeitlimit überschritten, oder dieser Computer ist nicht richtig konfiguriert, um die freigegebene Internetverbindung zu verwenden. <br><br>Klicken Sie auf <b>Wiederholen</b>, um erneut eine Verbindung herzustellen.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Der Computer ist nicht über das Netzwerk mit dem Internet verbunden. <br><br>Überprüfen Sie die Netzwerkeinstellungen, und vergewissern Sie sich, dass Sie eine Verbindung mit dem Internet herstellen können, bevor Sie den Vorgang wiederholen.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Der Computer ist nicht über das Netzwerk mit dem Internet verbunden. <br><br>Wählen Sie eine der folgenden Verbindungsmethoden:";
