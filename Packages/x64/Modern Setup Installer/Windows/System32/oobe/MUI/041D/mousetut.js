...
var L_RewardStr1_Text="Bra!";
var L_RewardStr2_Text="Nu är det klart!";
var L_RewardStr3_Text="Just precis!";
var L_RewardStr4_Text="Utmärkt!";
var L_RewardStr5_Text="Så enkelt är det!";
var L_RewardStr6_Text="Enastående!";
var L_RewardStr7_Text="Bravo!";
var L_RewardStr8_Text="Otroligt!";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "Seattle Seahawks vann över Steelers.";
