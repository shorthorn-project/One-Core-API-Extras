...
var L_altnumber01_Text = "* <u>S</u>lå detta alternativa nummer:";
var L_outsideline_Text = "<u>I</u>nkludera detta nummer för att få extern linje:";
var L_outsideline01_Text = "* <u>I</u>nkludera detta nummer för att få extern linje:";
var L_callwaiting_Text = "Inaktivera s<u>a</u>mtal väntar:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Om du vill fortsätta utan att utföra den här aktiviteten, klicka på <b>Påminn mig senare</b>.";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr6_Text = "Om du vill fortsätta utan att registrera datorn klickar du på <b>Hoppa över</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Onlineregistrering och aktivering finns ännu inte tillgängligt i ditt land eller område. Kontakta %1 om du vill registrera datorn utan Internet-anslutning. Du kan aktivera den här Windows-kopian genom Internet eller genom att ringa Microsoft.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Onlineregistrering och aktivering finns ännu inte i ditt land eller område. Du kan aktivera den här Windows-kopian genom Internet eller genom att ringa Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Onlineaktivering finns ännu inte tillgängligt i ditt land eller område. Du kan aktivera den här Windows-kopian genom Internet eller genom att ringa Microsoft. Kontakta %1 om du vill registrera din dator via telefon.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "Onlineaktivering finns ännu inte tillgängligt i ditt land eller område.  Du kan aktivera den Windows-kopian genom Internet eller genom att ringa Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Onlineregistrering finns ännu inte tillgängligt i ditt land eller område. Kontakta %1 om du vill registrera din dator via telefon.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
