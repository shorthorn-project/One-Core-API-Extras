...
var L_ERR_HN_UNAVAILABLE_Text = "Windows ei voinut muodostaa Internet-yhteyttä verkon välityksellä. Varmista, että verkkokaapeli on oikein kiinnitetty tietokoneeseen ja verkkoon.";


var L_ERRSTOPPED_Text = "Internet-yhteyden jakaminen ei ole käytettävissä verkossa. Yritä muodostaa yhteys uudelleen valitsemalla <b>Yritä uudelleen</b>.";
var L_ERR_PERM_DISCONNECTED_Text = "Internet-yhteyden jakaminen on poistettu käytöstä. Jos käytät Internet-yhteydessä suurinopeuksista sovitinta (esimerkiksi laajakaistayhteyttä), varmista, että sovitin on oikein määritetty ja kaapelit on oikein kiinnitetty.<br><br>Valitse sen jälkeen <b>Yritä uudelleen</b>.";
var L_ERRTIMEOUT_Text = "Internet-yhteydessä on ilmennyt ongelma. Aikakatkaisu on katkaissut yhteyden tai tämän tietokoneen asetukset eivät vastaa jaetun Internet-yhteyden määrityksiä. <br><br>Yritä yhteyden muodostamista uudelleen valitsemalla <b>Yritä uudelleen</b>.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Tietokone ei ole yhteydessä Internetiin verkon kautta. <br><br>Tarkista verkon asetukset ja varmista Internet-yhteyden saatavuus. Yritä sen jälkeen uudelleen.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Tietokone ei ole yhteydessä Internetiin verkon kautta. <br><br>Valitse jokin seuraavista tavoista:";
