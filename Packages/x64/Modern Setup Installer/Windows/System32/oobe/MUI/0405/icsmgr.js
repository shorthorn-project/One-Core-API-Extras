...
var L_ERR_HN_UNAVAILABLE_Text = "P¯ipojenÌ poËÌtaËe k Internetu prost¯ednictvÌm sÌtÏ bylo p¯eruöeno. <br><br>Chcete-li p¯ipojenÌ obnovit, ovÏ¯te, zda je sÌùov˝ kabel pevnÏ p¯ipojen k poËÌtaËi i sÌti.";


var L_ERRSTOPPED_Text = "Program SdÌlenÌ p¯ipojenÌ k Internetu nynÌ nenÌ v sÌti k dispozici. KlepnutÌm na tlaËÌtko <b>Opakovat</b> se pokuste znovu p¯ipojit.";
var L_ERR_PERM_DISCONNECTED_Text = "Program SdÌlenÌ p¯ipojenÌ k Internetu byl odpojen. Pokud se k sÌti p¯ipojujete vysokorychlostnÌm adaptÈrem (nap¯. öirokop·smov˝m), ujistÏte se, ûe byl spr·vnÏ nakonfigurov·n a ûe kabely jsou pevnÏ p¯ipojeny.<br><br>KlepnutÌm na tlaËÌtko <b>Opakovat</b> se pokuste znovu p¯ipojit.";
var L_ERRTIMEOUT_Text = "P¯i p¯ipojov·nÌ k Internetu doölo k potÌûÌm. P¯ipojenÌ vypröel Ëasov˝ limit nebo tento poËÌtaË nenÌ spr·vnÏ nakonfigurov·n na pouûÌv·nÌ programu SdÌlenÌ p¯ipojenÌ k Internetu. <br><br>KlepnutÌm na tlaËÌtko <b>Opakovat</b> se pokuste znovu p¯ipojit.";
var L_ERR_LAN_UNAVAILABLE1_Text = "PoËÌtaË nenÌ p¯ipojen k Internetu p¯es sÌù. <br><br>Zkontrolujte nastavenÌ sÌtÏ a potvrÔte, ûe se m˘ûete p¯ipojit k Internetu, a akci opakujte.";
var L_ERR_LAN_UNAVAILABLE2_Text = "PoËÌtaË nenÌ p¯ipojen k Internetu p¯es sÌù.  <br><br>Zvolte jednu z uveden˝ch metod:";
