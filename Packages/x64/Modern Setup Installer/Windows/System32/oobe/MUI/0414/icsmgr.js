...
var L_ERR_HN_UNAVAILABLE_Text = "Datamaskinen er ikke lenger koblet til Internett ved hjelp av nettverket. <br><br> Hvis du vil gjenopprette koblingen, kontroller at nettverkskabelen er koblet riktig til både datamaskinen og nettverket.";


var L_ERRSTOPPED_Text = "Deling av Internett-tilkobling er for øyeblikket ikke tilgjengelig på nettverket. Klikk <b>Prøv på nytt</b> for å prøve å koble deg til på nytt.";
var L_ERR_PERM_DISCONNECTED_Text = "Deling av Internett-tilkobling er frakoblet. Hvis du bruker et høyhastighetskort til å koble deg til Internett (for eksempel et bredbåndskort), må du kontrollere at kortet har riktig konfigurasjon, og at kablene er riktig festet.<br><br>Klikk <b>Prøv på nytt</b> for å prøve å koble deg til på nytt.";
var L_ERRTIMEOUT_Text = "Det har oppstått et problem med Internett-tilkoblingen. Enten er forbindelsen tidsavbrutt eller datamaskinen er ikke konfigurert for å kunne bruke den delte Internett-tilkoblingen. <br><br>Klikk <b>Prøv på nytt</b> for å prøve å koble deg til på nytt.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Datamaskinen er ikke koblet til Internett gjennom nettverket. <br><br>Kontroller nettverksinnstillingene, sjekk at du er i stand til å koble til Internett, og prøv på nytt.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Datamaskinen er ikke koblet til Internett gjennom nettverket. <br><br>Velg en av følgende metoder:";
