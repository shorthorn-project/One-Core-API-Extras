...
var L_RewardStr1_Text="Bom trabalho!";
var L_RewardStr2_Text="Já está!";
var L_RewardStr3_Text="É assim mesmo!";
var L_RewardStr4_Text="Excelente!";
var L_RewardStr5_Text="Tão simples como isso!";
var L_RewardStr6_Text="Fenomenal!";
var L_RewardStr7_Text="Excelente!";
var L_RewardStr8_Text="Estupendo!";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "Os Seattle Seahawks ganharam contra os Steelers.";
