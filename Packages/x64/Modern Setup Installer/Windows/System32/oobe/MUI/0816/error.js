...
var L_EnterValidPhoneNumber_Text = "Não é possível eliminar o número de telefone na totalidade.";
...
var L_altnumber_Text = "<u>M</u>arque este número alternativo:";
var L_altnumber01_Text = "* <u>M</u>arque este número alternativo:";
var L_outsideline_Text = "Inclua este número para obter uma linha <u>e</u>xterna:";
var L_outsideline01_Text = "* Inclua este número para obter uma <u>l</u>inha externa:";
var L_callwaiting_Text = "Desa<u>c</u>tivar atendimento autom.:";
var L_callwaiting01_Text = "* Desa<u>c</u>tivar atendimento autom.:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Para continuar sem efectuar esta tarefa, clique em <b>Lembrar depois</b>.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " <u>L</u>embrar depois ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "O programa de configuração não consegue ligar a este número para activar e registar o computador.";
    var L_tbstr2_Text = "O programa de configuração não conseguiu ligar a este número para activar o computador.";
    var L_tbstr3_Text = "O programa de configuração não consegue ligar a este número para registar o computador.";

    var L_tbstr4_Text = "Para continuar sem activar nem registar o computador, clique em <b>Ignorar</b>.";
    var L_tbstr5_Text = "Para continuar sem activar o computador, clique em <b>Ignorar</b>.";
    var L_tbstr6_Text = "Para continuar sem registar o computador, clique em <b>Ignorar</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "O registo e a activação online não estão actualmente disponíveis no seu país ou região. Para registar o computador sem uma ligação à Internet, contacte %1. Pode activar a sua cópia do Windows utilizando uma ligação à Internet ou contactando a Microsoft telefonicamente.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "O registo e activação online não estão actualmente disponíveis no seu país ou região. Pode activar a sua cópia do Windows utilizando uma ligação à Internet ou contactando a Microsoft telefonicamente. Para registar a sua cópia do Windows junto da Microsoft é necessária uma ligação à Internet.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "A activação online não está actualmente disponível no seu país ou região. Pode activar a sua cópia do Windows utilizando uma ligação à Internet ou contactando a Microsoft telefonicamente. Para registar o seu computador mais tarde sem uma ligação à Internet, contacte %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "A activação online não está actualmente disponível no seu país ou região. Pode activar a sua cópia do Windows utilizando uma ligação à Internet ou contactando a Microsoft telefonicamente.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "A activação online não está actualmente disponível no seu país ou região. Para registar o computador sem uma ligação à Internet, contacte  %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
