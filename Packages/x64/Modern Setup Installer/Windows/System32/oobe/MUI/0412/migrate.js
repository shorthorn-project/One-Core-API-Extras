...
var L_REF_STATUS_DIALING_Text           = "전화 거는 중...";
var L_REF_STATUS_LOCATING_Text          = "서비스 검색 중";
var L_REF_STATUS_CONNECTING_Text        = "서비스에 연결 중";
var L_REF_STATUS_CONNECTED_Text         = "연결됨";

var L_REF_STATUS_DOWNLOAD_Text          = "ISP 정보 다운로드 중...";
var L_REFDIALTITLE_TEXT                 = "인터넷 서비스 공급자 검색 중";
var L_REFDIALINTRO_TEXT                 = "사용할 ISP를 선택하기 위해, 귀하의 지역에서 사용 가능한 인터넷 서비스 공급자(ISP) 목록을 검색하는 중입니다.";
...
var L_drdyref_2_ICS_Text = "새 컴퓨터에서 기존 인터넷 계정 설정을 사용할 수 있도록 인터넷 연결 공유를 사용하여 계정 정보를 가져옵니다.";

var L_drdyref_4_ICS_Text = "계속하려면 정보를 입력하고 <b>다음</b>을 클릭하십시오. 기존 계정을 가져오지 않고 계속 진행하려면 <b>건너뛰기</b>를 클릭하십시오.";

var L_drdymig_2_ICS_Text = "인터넷 연결 공유를 사용하여 사용자의 기존 인터넷 계정을 재설정합니다. 연결을 시작하려면 <b>다음</b>을 클릭하십시오.";

var L_drdymig_4_ICS_Text = "계속하려면 정보를 입력하고 <b>다음</b>을 클릭하십시오. 기존 인터넷 계정을 다시 설정하지 않고 계속 진행하려면 <b>건너뛰기</b>를 클릭하십시오.";
