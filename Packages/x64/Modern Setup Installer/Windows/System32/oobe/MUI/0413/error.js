...
var L_EnterValidPhoneNumber_Text = "Kan niet het volledige telefoonnummer verwijderen.";
...
var L_altnumber_Text = "<u>K</u>ies dit alternatieve nummer:";
var L_altnumber01_Text = "* <u>K</u>ies dit alternatieve nummer:";
var L_outsideline_Text = "Kies eerst dit nummer voor een <u>b</u>uitenlijn:";
var L_outsideline01_Text = "* Kies eerst dit nummer voor een <u>b</u>uitenlijn:";
var L_callwaiting_Text = "<u>W</u>isselgesprek uitschakelen met:";
var L_callwaiting01_Text = "* <u>W</u>isselgesprek uitschakelen met:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Klik op <b>Herinner mij later</b> als u zonder deze taak uit te voeren door wilt gaan.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " Herinner <u>m</u>ij hier later aan";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "Setup kan geen verbinding met dit telefoonnummer maken voor het activeren en registreren van uw computer.";
    var L_tbstr2_Text = "Setup kan geen verbinding met dit telefoonnummer maken om de computer te activeren.";
    var L_tbstr3_Text = "Setup kan geen verbinding met dit telefoonnummer maken om uw computer te registreren.";

    var L_tbstr4_Text = "Klik op <b>Overslaan</b> als u zonder de computer de activeren en te registreren door wilt gaan.";
    var L_tbstr5_Text = "Klik op <b>Overslaan</b> als u door wilt gaan zonder uw computer te activeren.";
    var L_tbstr6_Text = "Klik op <b>Overslaan</b> als u wilt doorgaan zonder de computer te registreren.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "On line registreren en activeren is niet beschikbaar in uw land of regio. Neem contact op met %1 als u uw computer zonder Internet-verbinding wilt registreren. U kunt uw exemplaar van Windows met behulp van een Internet-verbinding of via de telefoon bij Microsoft activeren.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "On line activeren is niet beschikbaar in uw land of regio. U kunt uw exemplaar van Windows met behulp van een Internet-verbinding activeren of door via de telefoon contact op te nemen met Microsoft. U hebt een Internet-verbinding nodig als u uw exemplaar van Windows bij Microsoft wilt registreren.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "On line activeren is niet beschikbaar in uw land of regio. U kunt uw exemplaar van Windows met behulp van een Internet-verbinding activeren of door via de telefoon contact op te nemen met Microsoft. Neem contact op met %1 als u uw computer later zonder een Internet-verbinding wilt registreren.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "On line activeren is niet beschikbaar in uw land of regio. U kunt uw exemplaar van Windows met behulp van een Internet-verbinding activeren of door via de telefoon contact op te nemen met Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "On line registreren is niet beschikbaar in uw land of regio. Neem contact op met %1 als u uw computer zonder Internet-verbinding wilt registreren.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
