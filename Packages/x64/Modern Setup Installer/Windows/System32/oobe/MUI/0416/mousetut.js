...
var L_RewardStr2_Text="Isso mesmo!";
var L_RewardStr3_Text="Certo!";
var L_RewardStr4_Text="Excelente!";
var L_RewardStr5_Text="É fácil assim!";
var L_RewardStr6_Text="Maravilha!";
var L_RewardStr7_Text="Perfeito!";
var L_RewardStr8_Text="Incrível!";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "Seattle Seahawks ganhou do Steelers.";
