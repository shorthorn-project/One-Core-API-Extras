...
var L_ERR_HN_UNAVAILABLE_Text = "Seu computador não está mais conectado à Internet pela rede. <br><br>Para restaurar a conexão, verifique se o cabo de rede está bem conectado ao computador e à rede.";


var L_ERRSTOPPED_Text = "O compartilhamento de conexão com a Internet não está disponível no momento na rede. Clique em <b>Repetir</b> para tentar se conectar novamente.";
var L_ERR_PERM_DISCONNECTED_Text = "MILS: O compartilhamento de conexão com a Internet foi desconectado. Se você estiver usando um adaptador de alta velocidade para conectar-se à Internet (ex., banda larga), verifique se ele foi corretamente configurado e se os cabos estão bem conectados.<br><br>Clique em <b>Repetir</b> para tentar se conectar novamente.";
var L_ERRTIMEOUT_Text = "Problemas na conexão com a Internet. O tempo limite da conexão esgotou ou este computador não está configurado corretamente para usar a conexão compartilhada com a Internet. <br><br>Clique em <b>Repetir</b> para tentar se conectar novamente.";
var L_ERR_LAN_UNAVAILABLE1_Text = "Seu computador não está conectado à Internet por meio da rede. <br><br>Verifique as configurações de rede e confirme que você pode se conectar à Internet e tente novamente.";
var L_ERR_LAN_UNAVAILABLE2_Text = "Seu computador não está conectado à Internet por meio da rede. <br><br>Selecione um destes métodos:";
