...
var L_EnterValidPhoneNumber_Text = "无法删除整个电话号码。";
...
var L_altnumber_Text = "拨打此备用号码(<u>D</u>):";
var L_altnumber01_Text = "* 拨打此备用号码(<u>D</u>):";
var L_outsideline_Text = "在电话号码中加入此号码以拨打外线(<u>O</u>):";
var L_outsideline01_Text = "* 在电话号码中加入此号码以拨打外线(<u>O</u>):";
var L_callwaiting_Text = "禁用呼叫等待(<u>C</u>):";
var L_callwaiting01_Text = "* 禁用呼叫等待(<u>C</u>):";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "要不执行此任务而继续，请单击<b>以后提醒我</b>。";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " 之后提醒我(<u>M</u>)";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "安装程序无法连接到此号码来激活并注册您的计算机。";
    var L_tbstr2_Text = "安装程序无法连接到此号码来激活您的计算机。";
    var L_tbstr3_Text = "安装程序无法连接到此号码来注册您的计算机。";

    var L_tbstr4_Text = "要不激活和注册您的计算机而继续，请单击<b>跳过</b>。";
    var L_tbstr5_Text = "要不激活您的计算机而继续，请单击<b>跳过</b>。";
    var L_tbstr6_Text = "要不注册您的计算机而继续，请单击<b>跳过</b>。";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "您的国家或地区现在没有网上注册和激活服务。若不使用 Internet 连接来注册您的计算机，请与 %1 联系。您可以使用 Internet 连接或用电话与 Microsoft 联系来激活您的 Windows。";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "您的国家或地区现在没有网上注册和激活服务。您可以使用 Internet 连接或用电话与 Microsoft 联系来激活您的 Windows。要向 Microsoft 注册您的 Windows，您需要 Internet 连接。";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "您的国家或地区现在没有网上激活服务。您可以使用 Internet 连接或用电话与 Microsoft 联系来激活您的 Windows。若不使用 Internet 连接来注册您的计算机，请与 %1 联系。";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "您的国家或地区现在没有网上激活服务。您可以使用 Internet 连接或用电话与 Microsoft 联系来激活您的 Windows。";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "您的国家或地区现在没有网上注册服务。若不使用 Internet 连接来注册您的计算机，请与 %1 联系。";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
