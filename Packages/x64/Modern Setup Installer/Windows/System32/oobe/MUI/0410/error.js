...
var L_outsideline_Text = "Includi questo numero per accedere alla linea <u>e</u>sterna:";
var L_outsideline01_Text = "* Includi questo numero per accedere alla linea <u>e</u>sterna:";
var L_callwaiting_Text = "Disattiva avviso di <u>c</u>hiamata:";
var L_callwaiting01_Text = "* Disattiva avviso di <u>c</u>hiamata:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater01_Text = " Visua<u>l</u>izza in seguito ";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "L'attivazione e la registrazione in linea non sono al momento disponibili. Per registrare il computer senza utilizzare una connessione Internet, contattare %1. È possibile attivare la copia di Windows utilizzando una connessione  Internet o contattando Microsoft per telefono.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "L'attivazione e la registrazione in linea non sono al momento disponibili. È possibile attivare la copia di Windows utilizzando una connessione Internet o contattando Microsoft per telefono. È necessaria una connessione Internet per registrare la copia di Windows con Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "L'attivazione in linea non è al momento disponibile. È possibile attivare la copia di Windows utilizzando una connessione Internet o contattando Microsoft per telefono. Per registrare il computer senza utilizzare una connessione Internet, contattare %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "L'attivazione in linea non è al momento disponibile. È possibile attivare la copia di Windows utilizzando una connessione Internet o contattando Microsoft per telefono.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "La registrazione in linea non è al momento disponibile. Per registrare il computer senza utilizzare una connessione Internet, contattare %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
