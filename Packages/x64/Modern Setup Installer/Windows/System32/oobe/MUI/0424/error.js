...
var L_EnterValidPhoneNumber_Text = "Celotne telefonske številke ni mogoèe izbrisati.";
...
var L_altnumber_Text = "<u>K</u>lièi to nadomestno številko:";
var L_altnumber01_Text = "*<u>K</u>lièi to nadomestno številko:";
var L_outsideline_Text = "<u>Z</u>a zunanjo linijo vkljuèi to številko:";
var L_outsideline01_Text = "*<u>Z</u>a zunanjo linijo vkljuèi to številko:";
var L_callwaiting_Text = "Onemogoèi è<u>a</u>kajoèi klic:";
var L_callwaiting01_Text = "*Onemogoèi è<u>a</u>kajoèi klic:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Èe želite nadaljevati, ne da bi izvedli to opravilo, kliknite <b>Opomni me pozneje</b>.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " Opo<u>m</u>ni me pozneje ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "Namestitveni program ne more vzpostaviti povezave s to številko za aktiviranje in registriranje vašega raèunalnika.";
    var L_tbstr2_Text = "Namestitveni program ne more vzpostaviti povezave s to številko za aktiviranje vašega raèunalnika.";
    var L_tbstr3_Text = "Namestitveni program ne more vzpostaviti povezave s to številko za registriranje vašega raèunalnika.";

    var L_tbstr4_Text = "Èe želite nadaljevati brez aktiviranja in registriranja, kliknite <b>Preskoèi</b>.";
    var L_tbstr5_Text = "Èe želite nadaljevati brez aktiviranja, kliknite <b>Preskoèi</b>.";
    var L_tbstr6_Text = "Èe želite nadaljevati brez registracije, kliknite <b>Preskoèi</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Elektronsko registriranje in aktiviranje v vaši državi ali regiji trenutno nista na voljo. Èe želite svoj raèunalnik registrirati brez internetne povezave, se obrnite na %1. Kopijo programa Windows lahko aktivirate prek internetna ali tako, da poklièete Microsoft.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Elektronsko registriranje in aktiviranje v vaši državi ali regiji trenutno nista na voljo. Kopijo programa Windows lahko aktivirate pozneje prek interneta ali tako, da poklièete Microsoft. Za registracijo programa Windows potrebujete internetno povezavo.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Elektronsko aktiviranje v vaši državi ali regiji trenutno ni na voljo. Kopijo programa Windows lahko aktivirate prek interneta ali tako, da poklièete Microsoft. Èe želite svoj raèunalnik registrirati brez interneta, se obrnite na %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "Elektronsko aktiviranje v vaši državi ali regiji trenutno ni na voljo. Kopijo programa Windows lahko aktivirate prek interneta ali tako, da poklièete Microsoft.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Elektronsko aktiviranje v vaši državi ali regiji trenutno ni na voljo. Èe želite svoj raèunalnik registrirati brez interneta, se obrnite na %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
