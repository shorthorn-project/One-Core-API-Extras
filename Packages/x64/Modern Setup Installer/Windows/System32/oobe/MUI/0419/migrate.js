...
var L_REF_STATUS_DIALING_Text           = "Набор номера...";
var L_REF_STATUS_LOCATING_Text          = "Поиск службы";
var L_REF_STATUS_CONNECTING_Text        = "Подключение к службе";
var L_REF_STATUS_CONNECTED_Text         = "Подключено";

var L_REF_STATUS_DOWNLOAD_Text          = "Загрузка сведений о поставщиках услуг Интернета...";
var L_REFDIALTITLE_TEXT                 = "Поиск поставщиков услуг Интернета в вашей области";
var L_REFDIALINTRO_TEXT                 = "Корпорация Майкрософт получает список поставщиков служб Интернета (ISP) в вашем городе или области...";
...
var L_drdyref_2_ICS_Text = "Система Windows будет использовать общее подключение к Интернету для переноса существующих параметров учетной записи Интернета, чтобы использовать их с новым компьютером";

var L_drdyref_4_ICS_Text = "Предоставьте указанные ниже сведения и нажмите кнопку <b>Далее</b>. Чтобы продолжить работу без переноса данных существующей записи, нажмите кнопку <b>Пропустить</b>.";

var L_drdymig_2_ICS_Text = "Система Windows будет использовать общее подключение к Интернету, чтобы начать переустановку существующей учетной записи Интернета. &nbsp; Чтобы начать подключение, нажмите кнопку  <b>Далее</b>.";

var L_drdymig_4_ICS_Text = "Предоставьте указанные ниже сведения и нажмите кнопку <b>Далее</b>. Чтобы продолжить работу без переустановки существующей учетной записи Интернета, нажмите кнопку <b>Пропустить</b>.";
