...
var L_EnterValidPhoneNumber_Text = "Не удается удалить номер телефона целиком.";
...
var L_altnumber_Text = "Н<u>а</u>брать этот альтернативный номер:";
var L_altnumber01_Text = "* Н<u>а</u>брать этот альтернативный номер:";
var L_outsideline_Text = "Для выхода на <u>г</u>ородскую линию использовать этот номер:";
var L_outsideline01_Text = "* Для выхода на <u>г</u>ородскую линию использовать этот номер:";
var L_callwaiting_Text = "Откл<u>ю</u>чить режим принятия входящих звонков:";
var L_callwaiting01_Text = "* Откл<u>ю</u>чить режим принятия входящих звонков:";
...
function Enable_TelBtn_ActMode()
{
    if (InActivation_AppMode())
    {
        ...
        var L_RemindMeLater_Text = "Чтобы продолжить без выполнения данного действия, щелкните <b>Напомнить позже</b>.";
        g.RemindMeLaterText.innerHTML = L_RemindMeLater_Text;
        var L_RemindMeLater01_Text = " Н<u>а</u>помнить позже ";
...
function NewToobusy_LoadMe()
{
    ...
    var L_tbstr1_Text = "Программе установки не удается связаться с этим номером для активации и регистрации продукта.";
    var L_tbstr2_Text = "Программе установки не удается связаться с этим номером для активации продукта.";
    var L_tbstr3_Text = "Программе установки не удается связаться с этим номером для регистрации продукта.";

    var L_tbstr4_Text = "Чтобы продолжить без активации и регистрации продукта, щелкните <b>Пропустить</b>.";
    var L_tbstr5_Text = "Чтобы продолжить без активации, щелкните <b>Пропустить</b>.";
    var L_tbstr6_Text = "Чтобы продолжить работу без регистрации компьютера, нажмите кнопку <b>Пропустить</b>.";
...
function DesktopPbErr_LoadMe()
{
    ...
    if (g_DoActivation)
    {
        if  ((g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Регистрация и активация через Интернет в вашей стране или регионе в настоящий момент не доступна. Для регистрации без использования подключения к Интернету свяжитесь с %1. Вы можете активировать Windows , используя подключение к Интернету или позвонив по телефону в центр активации.";
        ...
        else if ((g_PostToMS) && (!g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Регистрация и активация через Интернет в вашей стране или регионе в настоящий момент не доступна. Вы можете активировать Windows , используя подключение к Интернету или позвонив по телефону в центр активации. Для регистрации Windows требуется подключение к Интернету.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
        else if ((!g_PostToMS) && (g_PostToOEM))
        {
            L_DeskMainPBerrMsg_Text        = "Активация через Интернет в вашей стране или регионе в настоящий момент не доступна. Вы можете активировать Windows , используя подключение к Интернету или позвонив по телефону в центр активации. Для регистрации без использования подключения к Интернету свяжитесь с %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
        else
        {
            ...
            L_DeskMainPBerrMsg_Text        = "Активация через Интернет в вашей стране или регионе в настоящий момент не доступна. Вы можете активировать Windows , используя подключение к Интернету или позвонив по телефону в центр активации.";
            g.Desktoppberr_par1.innerText  = L_DeskMainPBerrMsg_Text;
        }
    }
    else
    {
        if ((!g_PostToMS) && (g_PostToOEM))
        {
            ...
            GetPageTitle();
            L_DeskMainPBerrMsg_Text        = "Регистрация через Интернет в вашей стране или регионе в настоящий момент не доступна. Для регистрации без использования подключения к Интернету свяжитесь с %1.";
            g.Desktoppberr_par1.innerText  = ApiObj.FormatMessage(L_DeskMainPBerrMsg_Text, L_DeskpbErrOEMName_Text);
        }
    }
