...
var L_REF_STATUS_DIALING_Text           = "Vyt·Ëa sa...";
var L_REF_STATUS_LOCATING_Text          = "Vyhæad·vanie sluûby";
var L_REF_STATUS_CONNECTING_Text        = "Prip·janie sluûby";
var L_REF_STATUS_CONNECTED_Text         = "PripojenÈ";

var L_REF_STATUS_DOWNLOAD_Text          = "Preberaj˙ sa inform·cie o poskytovateæoch internetov˝ch sluûieb...";
var L_REFDIALTITLE_TEXT                 = "Hæadaj˙ sa poskytovatelia internetov˝ch sluûieb vo vaöej oblasti.";
var L_REFDIALINTRO_TEXT                 = "SpoloËnosù Microsoft naËÌtava zoznam poskytovateæov internetov˝ch sluûieb vo vaöej oblasti, z ktor˝ch si budete vyberaù.";
...
var L_drdyref_2_ICS_Text = "Pomocou zdieæanÈho internetovÈho pripojenia teraz systÈm Windows prenesie nastavenie existuj˙ceho internetovÈho konta, aby ste ho mohli pouûÌvaù na novom poËÌtaËi.";

var L_drdyref_4_ICS_Text = "Ak chcete pokraËovaù, zadajte poûadovanÈ inform·cie niûöie a kliknite na tlaËidlo <b>œalej</b>. Ak chcete pokraËovaù bez prenosu nastavenia existuj˙ceho konta, kliknite na tlaËidlo <b>PreskoËiù</b>.";

var L_drdymig_2_ICS_Text = "SystÈm Windows teraz prostrednÌctvom zdieæanÈho internetovÈho pripojenia zaËne s obnovenÌm existuj˙ceho internetovÈho konta. &nbsp; Ak chcete spustiù prip·janie, kliknite na tlaËidlo <b>œalej</b>.";

var L_drdymig_4_ICS_Text = "Ak chcete pokraËovaù, zadajte poûadovanÈ inform·cie niûöie a kliknite na tlaËidlo <b>œalej</b>. Ak chcete pokraËovaù bez obnovenia existuj˙ceho internetovÈho konta, kliknite na tlaËidlo <b>PreskoËiù</b>.";
