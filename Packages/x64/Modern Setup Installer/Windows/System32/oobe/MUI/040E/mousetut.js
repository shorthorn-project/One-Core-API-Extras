...
var L_RewardStr1_Text="Szép munka!";
var L_RewardStr2_Text="Ennyi az egész!";
var L_RewardStr3_Text="Ez megvan!";
var L_RewardStr4_Text="Kiváló!";
var L_RewardStr5_Text="Ilyen egyszerû!";
var L_RewardStr6_Text="Kitûnõ!";
var L_RewardStr7_Text="Nagyon jó!";
var L_RewardStr8_Text="Fantasztikus!";
...
function MouseTut_LoadMe_PageK() {
  ...
  if(g_MouseTutCityStr==null) {
     ...
     g_FrameSelected=true;
     g_BorderSelected=true;
     var L_CaptionString_Text = "A Manchester United gyõzött az Arsenal ellen.";
