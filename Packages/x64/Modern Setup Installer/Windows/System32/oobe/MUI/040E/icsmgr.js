...
var L_ERR_HN_UNAVAILABLE_Text = "A számítógép nem csatlakozik az internetre a hálózaton keresztül. <br><br>A kapcsolat helyreállításához gyõzõdjön meg arról, hogy a hálózati kábel megfelelõen csatlakozik a számítógéphez és a hálózathoz.";


var L_ERRSTOPPED_Text = "Az internetkapcsolat megosztása pillanatnyilag nem érhetõ el a hálózaton. A csatlakozás megismétléséhez kattintson az <b>Újra</b> gombra.";
var L_ERR_PERM_DISCONNECTED_Text = "Az internetkapcsolat megosztása nincs csatlakoztatva. Ha nagysebességû csatoló használatával csatlakozik az internetre (például szélessávú csatoló), ellenõrizze, hogy a csatoló konfigurálása és a kábelek csatlakoztatása megfelelõ-e.<br><br>A csatlakozás megismétléséhez kattintson az <b>Újra</b> gombra.";
var L_ERRTIMEOUT_Text = "Hiba történt az internetre való csatlakozás során. A kapcsolat túllépte a megadott idõkorlátot, vagy a számítógép nincs megfelelõen konfigurálva a megosztott internetkapcsolat használatára. <br><br>A csatlakozás megismétléséhez kattintson az <b>Újra</b> gombra.";
var L_ERR_LAN_UNAVAILABLE1_Text = "A számítógép nem kapcsolódik az internethez a hálózaton keresztül. <br><br>Ellenõrizze a hálózati beállításokat, és gyõzõdjön meg arról, hogy tud az internetre kapcsolódni, majd próbálja meg újra.";
var L_ERR_LAN_UNAVAILABLE2_Text = "A számítógép nem kapcsolódik az internethez a hálózaton keresztül. <br><br>Válasszon az alábbi módszerek közül:";
